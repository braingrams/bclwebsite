...
module.exports = __webpack_require__(2006);
...
window.conversionGoal = 'udid_conversion_goal';
...
var udidId = document.querySelector(".js-udid-value");

var udidCopyButton = document.querySelector(".js-udid-copy");
udidCopyButton.addEventListener("click", handleCopyButtonClick, false);

function showIOSSection(udid) {
	var iosSection = document.querySelector(".js-udid-ios");
	iosSection.style.display = "block";
}

function showCommonSection() {
	var commonSection = document.querySelector(".js-udid");
...
requestEstimateLink.init(".b-what_we_do_old a#request-estimate");
revolution.init();
customers.init();
