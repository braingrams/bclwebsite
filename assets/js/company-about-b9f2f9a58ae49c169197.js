...
window.conversionGoal = 'about_conversion_goal';
...
var _Carousel = __webpack_require__(1559);
...
function init() {
    var domElements = document.querySelectorAll(".b-parallax-elementXY");
    ...
    if (domElements.length) {
        for (var i = 0; i < domElements.length; i++) {
            ...
            parallaxElements.push({
                ...
                speedX: parseFloat(domElement.dataset.speedx) || 0,
                speedY: parseFloat(domElement.dataset.speedy) || 0
            });
        }
...
function onScroll() {
    ...
    parallaxElements.forEach(function (parallaxElement) {
        ...
        parallaxElement.domElement.style.transform = "translate3d(" + elementTranslateY * parallaxElement.speedX + "px, " + elementTranslateY * parallaxElement.speedY + "px, 0)";
    });
}
...
var slider = document.querySelector('.structure__slider');

var structureSlider = void 0;
var clientWidth = document.body.clientWidth;

var touchEvents = document.querySelector('.touchevents');

var sliderInit = function sliderInit() {
    if (!view.isDesktop() || touchEvents) {
        structureSlider = new _swiper2.default(slider, {
            mode: 'horizontal',
            speed: 250,
            slidesPerView: 'auto',
            loop: false,
            slideActiveClass: 'structure__slide--active'
        });
    }
};
...
var resizeHandlerSlider = function resizeHandlerSlider() {
    if (clientWidth !== document.body.clientWidth) {
        ...
        touchEvents = document.querySelector('.touchevents');

        view._resize();

        if (structureSlider) {
            structureSlider.destroy();
        }
...
var view = _View2.default.getInstance();
var section = document.querySelector('.about__what-we-do');
...
var sliderInit = function sliderInit() {
    if (view.isMobile()) {
        swiperCarousel = new _swiper2.default(slider, {
            ...
            pagination: {
                bulletActiveClass: 'slider__bullets__item--active',
                bulletClass: 'slider__bullets__item',
                clickable: true,
                el: '.slider__bullets',
                type: 'bullets'
            },
...
var view = _View2.default.getInstance();
var section = document.querySelector('.about__education');
