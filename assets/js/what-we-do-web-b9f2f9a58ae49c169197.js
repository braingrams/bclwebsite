...
module.exports = __webpack_require__(2165);
 ...
 * @private
 */
var slideRequestForm = new _form2.default();
...
var _AnimatedBackground = __webpack_require__(238);

var _AnimatedBackground2 = _interopRequireDefault(_AnimatedBackground);

var _slide = __webpack_require__(131);

var _slide2 = _interopRequireDefault(_slide);

var _projectStepsCarousel = __webpack_require__(498);
...
if (canvasElements.length) {
    for (var i = 0; i < canvasElements.length; i++) {
        animatedBackgrounds.push(new _AnimatedBackground2.default(canvasElements[i]));
    }
}

var slideRequestForm = new _slide2.default();
slideRequestForm.init(document.querySelector(".js-request_estimate-slide"));

(0, _projectStepsCarousel.getCarouselType)();
(0, _slider.insertSlider)();

window.addEventListener("load", function () {
    (0, _landing.initLandingWithScrollableSlider)();
}, false);
...
var section = document.querySelector('.web__03');
...
var sliderInit = function sliderInit() {
    if (view.isMobile() || view.isDesktopMini()) {
...
var initAutoPlay2 = function initAutoPlay2() {
    if (view.isMobile() || view.isDesktopMini()) {
        ...
        while (!current.classList.contains('landing__section')) {
...
var view2 = _View2.default.getInstance();
var section2 = document.querySelector('.web__04');
var slider2 = section2.querySelector('.landing__carousel3-container--mobile--images');

var swiperCarousel2 = void 0;
var clientWidth = document.body.clientWidth;


var changeContentSlide2 = function changeContentSlide2(newIndex) {
    if (typeof newIndex === 'undefined') {
        return;
    }

    var activeClassName = 'landing__carousel3-container--mobile--content__item--active';
    var slides = section2.querySelectorAll('.landing__carousel3-container--mobile--content__item');
    var activeSlide = section2.querySelector('.' + activeClassName);
...
var sliderInit2 = function sliderInit2() {
    if (view2.isMobile() || view2.isDesktopMini()) {
        swiperCarousel2 = new _swiper2.default(slider2, {
            loop: true,
            loopAdditionalSlides: 2,

            navigation: {
                nextEl: '.landing__carousel3-container--mobile__swiper-button-next',
                prevEl: '.landing__carousel3-container--mobile__swiper-button-prev'
            },
            ...
            pagination: {
                bulletActiveClass: 'slider__bullets3__item--active',
                bulletClass: 'slider__bullets3__item',
                clickable: true,
                el: '.slider__bullets3',
                type: 'bullets'
            },
            ...
            on: {
                slideChangeTransitionStart: function slideChangeTransitionStart() {
                    if (swiperCarousel2) {
                        changeContentSlide2(swiperCarousel2.realIndex);
                    }
                },

                reachEnd: function reachEnd() {
                    swiperCarousel2.autoplay.stop();
                }
            }
        });
    }
...
var initAutoPlay3 = function initAutoPlay3() {
    if (view2.isMobile() || view2.isDesktopMini()) {

        if (swiperCarousel2.autoplay.running) {
            return;
        }

        var current = swiperCarousel2.wrapperEl;
        ...
        if (bounding.top < 0) {
            swiperCarousel2.autoplay.start();
            swiperCarousel2.params.autoplay.delay = 5000;
            swiperCarousel2.params.autoplay.disableOnInteraction = false;
        }
    }
};

window.addEventListener('scroll', initAutoPlay3);

var resizeHandlerSlider2 = function resizeHandlerSlider2() {
    if (clientWidth !== document.body.clientWidth) {
        clientWidth = document.body.clientWidth;
        ...
        if (swiperCarousel2) {
            swiperCarousel2.destroy();
            changeContentSlide2(0);
        }
...
window.addEventListener('resize', resizeHandlerSlider2);
sliderInit2();
initAutoPlay3();
...
function initLandingWithScrollableSlider() {
    // Return on IE
    ...
    if (containerElement1) {
        ...
        var handleResize = function handleResize() {
            if (window.matchMedia("(min-width: 1025px)").matches) {
                ...
                extraHeight = containerElement2.offsetWidth * 2;

                deltaWidth = sliderContainerElement.offsetWidth - scrollSectionElement.offsetWidth;
        ...
        var handleScroll = function handleScroll() {
            ...
            var stopScrollOffsetY = getElementOffsetTop(scrollSectionElement) - (window.innerHeight - scrollSectionElement.offsetHeight) / 2;
            ...
            if (dy < 0) {
                ...
                left = -deltaWidth * (1 - dy / deltaHeight);
            }

            containerElement2.style.transform = "translate3d(0, " + top + "px, 0)";
            sliderContainerElement.style.transform = "translate3d(" + Math.round(left) + "px, 0, 0)";
        };

        var containerElement2 = containerElement1.querySelector(".landing__scrollable-container-2");
        var scrollSectionElement = containerElement1.querySelector(".landing__slider-container--wrapper");
        var sliderContainerElement = containerElement1.querySelector(".landing__slider-container");

        var deltaWidth = void 0;
...
exports.initLandingWithScrollableSlider = initLandingWithScrollableSlider;
...
exports.insertSlider = undefined;
...
var sliderSection = document.querySelector('.landing__slider-section');
var slider = sliderSection.querySelector('.mobile__slider');

var swiperSlider = void 0;
var view = void 0;
var clientWidth = document.body.clientWidth;


var insertSlider = function insertSlider() {
    view = _View2.default.getInstance();

    if (view.isDesktop()) {
        return;
    }

    swiperSlider = new _swiper2.default(slider, {
        mode: 'horizontal',
        speed: 250,
        slidesPerView: 'auto',
        spaceBetween: 10,
        ...
        pagination: {
            bulletActiveClass: 'mobile__bullets-mobile__item--active',
            bulletClass: 'mobile__bullets-mobile__item',
            clickable: true,
            el: '.mobile__bullets-mobile',
            type: 'bullets'
        },
...
exports.insertSlider = insertSlider;
...
exports.getCarouselType = undefined;
...
_swiper2.default.use([_swiper.Navigation, _swiper.Pagination, _swiper.Autoplay, _swiper.EffectFade]);

var carousel = document.querySelector('.mobile__carousel');

var swiperCarousel = void 0;
var clientWidth = document.body.clientWidth;


var insertCarousel = function insertCarousel() {
    var effect = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'slide';

    swiperCarousel = new _swiper2.default(carousel, {
        mode: 'horizontal',
        slidesPerView: 'auto',
        spaceBetween: 10,
        speed: 300,
        ...
        on: {
            ...
            paginationRender: function paginationRender() {
                var bullets = document.querySelectorAll('.mobile__carousel__bullets__item');
        ...
        breakpoints: {
            ...
            1160: {
                ...
                pagination: {
                    bulletClass: 'mobile__carousel__bullets__item',
                    clickable: true,
                    el: '.mobile__carousel__bullets',

                    renderCustom: function renderCustom(swiper, current, total) {
                        var bullets = '';
                        var TITLES = ['Scope Definition', 'Analysis & Design', 'Customer Reviews', 'Application Development', 'Quality Assurance', 'Deployment'];

                        for (var i = 0; i < total; i++) {
                            var active = current === i + 1 ? 'mobile__carousel__bullets--active' : '';

                            bullets += '<button class=\'mobile__carousel__bullets__item mobile__carousel__bullets__item--' + (i + 1) + ' ' + active + '\'>' + TITLES[i] + '</button>';
                        }
...
var initAutoPlay = function initAutoPlay() {
    ...
    if (bounding.top < 0) {
        swiperCarousel.autoplay.start();
        swiperCarousel.params.autoplay.delay = 7000;
        swiperCarousel.params.autoplay.disableOnInteraction = false;
    }
};
...
var resizeHandlerCarousel = function resizeHandlerCarousel() {
    if (clientWidth !== document.body.clientWidth) {
        clientWidth = document.body.clientWidth;
...
window.addEventListener('resize', resizeHandlerCarousel);

var view = _View2.default.getInstance();

var getCarouselType = function getCarouselType() {
    if (view.isDesktop()) {
        insertCarousel('fade');
    } else {
        insertCarousel();
...
exports.getCarouselType = getCarouselType;
