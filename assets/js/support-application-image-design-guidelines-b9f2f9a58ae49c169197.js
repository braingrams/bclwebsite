webpackJsonp(
  [89],
  {
    ...
    /***/ 1997: /***/ function (module, exports, __webpack_require__) {
      ...
      var switcherElement = document.querySelector(
        ".js-device-guidelines-switcher"
      );
      var switcherButtonElements = switcherElement.querySelectorAll("span");
      var guidlineTableElements = document.querySelectorAll(
        ".b-guidelines_table"
      );
      ...
      var handleButtonClick = function handleButtonClick(event) {
        ...
        for (var i = 0; i < switcherButtonElements.length; i++) {
          switcherButtonElements[i].classList.remove(
            "device-guidelines-switcher-button-active"
          );
        }
        ...
        for (var _i = 0; _i < guidlineTableElements.length; _i++) {
          guidlineTableElements[_i].classList.remove(
            "b-guidelines_table-active"
          );
        }

        var table = document.querySelector(
          ".b-guidelines_table-" + buttonElement.dataset.tabIndex
        );
      ...
      for (var i = 0; i < switcherButtonElements.length; i++) {
        switcherButtonElements[i].addEventListener(
          "click",
          handleButtonClick,
          false
        );
