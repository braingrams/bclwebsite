...
window.conversionGoal = 'guidlines_conversion_goal';
...
var switcherElement = document.querySelector(".js-device-guidelines-switcher");
var switcherButtonElements = switcherElement.querySelectorAll("span");
var guidlineTableElements = document.querySelectorAll(".b-guidelines_table");

var handleButtonClick = function handleButtonClick(event) {
    var buttonElement = event.currentTarget;

    for (var i = 0; i < switcherButtonElements.length; i++) {
        switcherButtonElements[i].classList.remove("device-guidelines-switcher-button-active");
    }

    buttonElement.classList.add("device-guidelines-switcher-button-active");

    for (var _i = 0; _i < guidlineTableElements.length; _i++) {
        guidlineTableElements[_i].classList.remove("b-guidelines_table-active");
    }

    var table = document.querySelector(".b-guidelines_table-" + buttonElement.dataset.tabIndex);

    if (table) {
        table.classList.add("b-guidelines_table-active");
    }
};

for (var i = 0; i < switcherButtonElements.length; i++) {
    switcherButtonElements[i].addEventListener("click", handleButtonClick, false);
}
