...
"use strict";
var pWaitFor = __webpack_require__(1775);

var hasYoutubeScript = false;
var scriptTags = document.querySelectorAll("script");

for (var i = 0; i < scriptTags.length; i++) {
    if (scriptTags[i].src.match(/www.youtube.com\/iframe_api/)) {
        hasYoutubeScript = true;
        break;
    }
}
...
function initYunicornPlayer() {
    var thumbnail = document.querySelector(".b-project-yunicorn-thumbnail");

    var player = new YT.Player("yunicorn-player", {
        videoId: "nzKSb2GX1Hk",
