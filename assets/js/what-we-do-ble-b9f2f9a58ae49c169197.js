...
window.conversionGoal = 'ble_conversion_goal';
...
(function () {
    var arrowLeft = document.querySelector(".experience-slider-arrow-left");
    var arrowRight = document.querySelector(".experience-slider-arrow-right");
    var slides = document.querySelectorAll(".experience-slide");
    var currentSlideIndex = 0;
    var isAnimating = false;

    for (var i = 0; i < slides.length; i++) {
        if (slides[i].classList.contains("experience-slide-current")) {
            currentSlideIndex = i;
            break;
        }
    }

    arrowLeft.addEventListener("click", showPreviousSlide, false);
    arrowRight.addEventListener("click", showNextSlide, false);
    ...
    function showSlide(slideIndex) {
        slides[currentSlideIndex].classList.remove("experience-slide-current");
        slides[slideIndex].classList.add("experience-slide-current");
