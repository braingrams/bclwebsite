...
function imageCheck() {
    ...
    if (slider.value < 2.5) {
        ...
        try {
            ...
            for (var _iterator = levels.children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    } else if (slider.value >= 2.5 && slider.value < 5) {
        var _iteratorNormalCompletion2 = true;
        var _didIteratorError2 = false;
        var _iteratorError2 = undefined;

        try {
            for (var _iterator2 = levels.children[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var _item = _step2.value;

                var _attrID = _item.getAttribute("id");
    ...
    } else if (slider.value >= 5 && slider.value < 7.5) {
        var _iteratorNormalCompletion3 = true;
        var _didIteratorError3 = false;
        var _iteratorError3 = undefined;

        try {
            for (var _iterator3 = levels.children[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                var _item2 = _step3.value;

                var _attrID2 = _item2.getAttribute("id");

                if (_attrID2 === "level3") {
                    _item2.classList.remove("hidden");
                } else {
    ...
    } else if (slider.value >= 7.5 && slider.value < 10) {
        var _iteratorNormalCompletion4 = true;
        var _didIteratorError4 = false;
        var _iteratorError4 = undefined;

        try {
            for (var _iterator4 = levels.children[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                var _item3 = _step4.value;

                var _attrID3 = _item3.getAttribute("id");

                if (_attrID3 === "level5") {
                    _item3.classList.remove("hidden");
                } else {
    ...
    } else if (slider.value >= 10 && slider.value < 12.5) {
        var _iteratorNormalCompletion5 = true;
        var _didIteratorError5 = false;
        var _iteratorError5 = undefined;

        try {
            for (var _iterator5 = levels.children[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                var _item4 = _step5.value;

                var _attrID4 = _item4.getAttribute("id");

                if (_attrID4 === "level6") {
                    _item4.classList.remove("hidden");
                } else {
                    _item4.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 12.5 && slider.value < 15) {
        var _iteratorNormalCompletion6 = true;
        var _didIteratorError6 = false;
        var _iteratorError6 = undefined;

        try {
            for (var _iterator6 = levels.children[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                var _item5 = _step6.value;

                var _attrID5 = _item5.getAttribute("id");

                if (_attrID5 === "level7") {
                    _item5.classList.remove("hidden");
                } else {
                    _item5.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 15 && slider.value < 17.5) {
        var _iteratorNormalCompletion7 = true;
        var _didIteratorError7 = false;
        var _iteratorError7 = undefined;

        try {
            for (var _iterator7 = levels.children[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                var _item6 = _step7.value;

                var _attrID6 = _item6.getAttribute("id");

                if (_attrID6 === "level7") {
                    _item6.classList.remove("hidden");
                } else {
                    _item6.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 17.5 && slider.value < 20) {
        var _iteratorNormalCompletion8 = true;
        var _didIteratorError8 = false;
        var _iteratorError8 = undefined;

        try {
            for (var _iterator8 = levels.children[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                var _item7 = _step8.value;

                var _attrID7 = _item7.getAttribute("id");

                if (_attrID7 === "level8") {
                    _item7.classList.remove("hidden");
                } else {
                    _item7.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 20 && slider.value < 22.5) {
        var _iteratorNormalCompletion9 = true;
        var _didIteratorError9 = false;
        var _iteratorError9 = undefined;

        try {
            for (var _iterator9 = levels.children[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                var _item8 = _step9.value;

                var _attrID8 = _item8.getAttribute("id");

                if (_attrID8 === "level9") {
                    _item8.classList.remove("hidden");
                } else {
                    _item8.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 22.5 && slider.value < 25) {
        var _iteratorNormalCompletion10 = true;
        var _didIteratorError10 = false;
        var _iteratorError10 = undefined;

        try {
            for (var _iterator10 = levels.children[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                var _item9 = _step10.value;

                var _attrID9 = _item9.getAttribute("id");

                if (_attrID9 === "level10") {
                    _item9.classList.remove("hidden");
                } else {
                    _item9.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 25 && slider.value < 27.5) {
        var _iteratorNormalCompletion11 = true;
        var _didIteratorError11 = false;
        var _iteratorError11 = undefined;

        try {
            for (var _iterator11 = levels.children[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                var _item10 = _step11.value;

                var _attrID10 = _item10.getAttribute("id");

                if (_attrID10 === "level11") {
                    _item10.classList.remove("hidden");
                } else {
                    _item10.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 27.5 && slider.value < 30) {
        var _iteratorNormalCompletion12 = true;
        var _didIteratorError12 = false;
        var _iteratorError12 = undefined;

        try {
            for (var _iterator12 = levels.children[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                var _item11 = _step12.value;

                var _attrID11 = _item11.getAttribute("id");

                if (_attrID11 === "level12") {
                    _item11.classList.remove("hidden");
                } else {
                    _item11.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 30 && slider.value < 32.5) {
        var _iteratorNormalCompletion13 = true;
        var _didIteratorError13 = false;
        var _iteratorError13 = undefined;

        try {
            for (var _iterator13 = levels.children[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
                var _item12 = _step13.value;

                var _attrID12 = _item12.getAttribute("id");

                if (_attrID12 === "level13") {
                    _item12.classList.remove("hidden");
                } else {
                    _item12.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 32.5 && slider.value < 35) {
        var _iteratorNormalCompletion14 = true;
        var _didIteratorError14 = false;
        var _iteratorError14 = undefined;

        try {
            for (var _iterator14 = levels.children[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
                var _item13 = _step14.value;

                var _attrID13 = _item13.getAttribute("id");

                if (_attrID13 === "level14") {
                    _item13.classList.remove("hidden");
                } else {
                    _item13.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 35 && slider.value < 37.5) {
        var _iteratorNormalCompletion15 = true;
        var _didIteratorError15 = false;
        var _iteratorError15 = undefined;

        try {
            for (var _iterator15 = levels.children[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
                var _item14 = _step15.value;

                var _attrID14 = _item14.getAttribute("id");

                if (_attrID14 === "level15") {
                    _item14.classList.remove("hidden");
                } else {
                    _item14.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 37.5 && slider.value < 40) {
        var _iteratorNormalCompletion16 = true;
        var _didIteratorError16 = false;
        var _iteratorError16 = undefined;

        try {
            for (var _iterator16 = levels.children[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
                var _item15 = _step16.value;

                var _attrID15 = _item15.getAttribute("id");

                if (_attrID15 === "level16") {
                    _item15.classList.remove("hidden");
                } else {
                    _item15.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 40 && slider.value < 42.5) {
        var _iteratorNormalCompletion17 = true;
        var _didIteratorError17 = false;
        var _iteratorError17 = undefined;

        try {
            for (var _iterator17 = levels.children[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
                var _item16 = _step17.value;

                var _attrID16 = _item16.getAttribute("id");

                if (_attrID16 === "level17") {
                    _item16.classList.remove("hidden");
                } else {
                    _item16.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 42.5 && slider.value < 45) {
        var _iteratorNormalCompletion18 = true;
        var _didIteratorError18 = false;
        var _iteratorError18 = undefined;

        try {
            for (var _iterator18 = levels.children[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
                var _item17 = _step18.value;

                var _attrID17 = _item17.getAttribute("id");

                if (_attrID17 === "level18") {
                    _item17.classList.remove("hidden");
                } else {
                    _item17.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 45 && slider.value < 47.5) {
        var _iteratorNormalCompletion19 = true;
        var _didIteratorError19 = false;
        var _iteratorError19 = undefined;

        try {
            for (var _iterator19 = levels.children[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
                var _item18 = _step19.value;

                var _attrID18 = _item18.getAttribute("id");

                if (_attrID18 === "level19") {
                    _item18.classList.remove("hidden");
                } else {
                    _item18.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 47.5 && slider.value < 50) {
        var _iteratorNormalCompletion20 = true;
        var _didIteratorError20 = false;
        var _iteratorError20 = undefined;

        try {
            for (var _iterator20 = levels.children[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
                var _item19 = _step20.value;

                var _attrID19 = _item19.getAttribute("id");

                if (_attrID19 === "level20") {
                    _item19.classList.remove("hidden");
                } else {
                    _item19.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 50 && slider.value < 52.5) {
        var _iteratorNormalCompletion21 = true;
        var _didIteratorError21 = false;
        var _iteratorError21 = undefined;

        try {
            for (var _iterator21 = levels.children[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
                var _item20 = _step21.value;

                var _attrID20 = _item20.getAttribute("id");

                if (_attrID20 === "level21") {
                    _item20.classList.remove("hidden");
                } else {
                    _item20.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 52.5 && slider.value < 55) {
        var _iteratorNormalCompletion22 = true;
        var _didIteratorError22 = false;
        var _iteratorError22 = undefined;

        try {
            for (var _iterator22 = levels.children[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
                var _item21 = _step22.value;

                var _attrID21 = _item21.getAttribute("id");

                if (_attrID21 === "level22") {
                    _item21.classList.remove("hidden");
                } else {
                    _item21.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 55 && slider.value < 57.5) {
        var _iteratorNormalCompletion23 = true;
        var _didIteratorError23 = false;
        var _iteratorError23 = undefined;

        try {
            for (var _iterator23 = levels.children[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
                var _item22 = _step23.value;

                var _attrID22 = _item22.getAttribute("id");

                if (_attrID22 === "level23") {
                    _item22.classList.remove("hidden");
                } else {
                    _item22.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 57.5 && slider.value < 60) {
        var _iteratorNormalCompletion24 = true;
        var _didIteratorError24 = false;
        var _iteratorError24 = undefined;

        try {
            for (var _iterator24 = levels.children[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
                var _item23 = _step24.value;

                var _attrID23 = _item23.getAttribute("id");

                if (_attrID23 === "level24") {
                    _item23.classList.remove("hidden");
                } else {
                    _item23.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 60 && slider.value < 62.5) {
        var _iteratorNormalCompletion25 = true;
        var _didIteratorError25 = false;
        var _iteratorError25 = undefined;

        try {
            for (var _iterator25 = levels.children[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
                var _item24 = _step25.value;

                var _attrID24 = _item24.getAttribute("id");

                if (_attrID24 === "level25") {
                    _item24.classList.remove("hidden");
                } else {
                    _item24.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 62.5 && slider.value < 65) {
        var _iteratorNormalCompletion26 = true;
        var _didIteratorError26 = false;
        var _iteratorError26 = undefined;

        try {
            for (var _iterator26 = levels.children[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
                var _item25 = _step26.value;

                var _attrID25 = _item25.getAttribute("id");

                if (_attrID25 === "level26") {
                    _item25.classList.remove("hidden");
                } else {
                    _item25.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 65 && slider.value < 67.5) {
        var _iteratorNormalCompletion27 = true;
        var _didIteratorError27 = false;
        var _iteratorError27 = undefined;

        try {
            for (var _iterator27 = levels.children[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
                var _item26 = _step27.value;

                var _attrID26 = _item26.getAttribute("id");

                if (_attrID26 === "level27") {
                    _item26.classList.remove("hidden");
                } else {
                    _item26.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 67.5 && slider.value < 70) {
        var _iteratorNormalCompletion28 = true;
        var _didIteratorError28 = false;
        var _iteratorError28 = undefined;

        try {
            for (var _iterator28 = levels.children[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
                var _item27 = _step28.value;

                var _attrID27 = _item27.getAttribute("id");

                if (_attrID27 === "level28") {
                    _item27.classList.remove("hidden");
                } else {
                    _item27.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 70 && slider.value < 72.5) {
        var _iteratorNormalCompletion29 = true;
        var _didIteratorError29 = false;
        var _iteratorError29 = undefined;

        try {
            for (var _iterator29 = levels.children[Symbol.iterator](), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
                var _item28 = _step29.value;

                var _attrID28 = _item28.getAttribute("id");

                if (_attrID28 === "level29") {
                    _item28.classList.remove("hidden");
                } else {
                    _item28.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 72.5 && slider.value < 75) {
        var _iteratorNormalCompletion30 = true;
        var _didIteratorError30 = false;
        var _iteratorError30 = undefined;

        try {
            for (var _iterator30 = levels.children[Symbol.iterator](), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
                var _item29 = _step30.value;

                var _attrID29 = _item29.getAttribute("id");

                if (_attrID29 === "level30") {
                    _item29.classList.remove("hidden");
                } else {
                    _item29.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 75 && slider.value < 77.5) {
        var _iteratorNormalCompletion31 = true;
        var _didIteratorError31 = false;
        var _iteratorError31 = undefined;

        try {
            for (var _iterator31 = levels.children[Symbol.iterator](), _step31; !(_iteratorNormalCompletion31 = (_step31 = _iterator31.next()).done); _iteratorNormalCompletion31 = true) {
                var _item30 = _step31.value;

                var _attrID30 = _item30.getAttribute("id");

                if (_attrID30 === "level31") {
                    _item30.classList.remove("hidden");
                } else {
                    _item30.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 77.5 && slider.value < 80) {
        var _iteratorNormalCompletion32 = true;
        var _didIteratorError32 = false;
        var _iteratorError32 = undefined;

        try {
            for (var _iterator32 = levels.children[Symbol.iterator](), _step32; !(_iteratorNormalCompletion32 = (_step32 = _iterator32.next()).done); _iteratorNormalCompletion32 = true) {
                var _item31 = _step32.value;

                var _attrID31 = _item31.getAttribute("id");

                if (_attrID31 === "level32") {
                    _item31.classList.remove("hidden");
                } else {
                    _item31.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 80 && slider.value < 82.5) {
        var _iteratorNormalCompletion33 = true;
        var _didIteratorError33 = false;
        var _iteratorError33 = undefined;

        try {
            for (var _iterator33 = levels.children[Symbol.iterator](), _step33; !(_iteratorNormalCompletion33 = (_step33 = _iterator33.next()).done); _iteratorNormalCompletion33 = true) {
                var _item32 = _step33.value;

                var _attrID32 = _item32.getAttribute("id");

                if (_attrID32 === "level33") {
                    _item32.classList.remove("hidden");
                } else {
                    _item32.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 82.5 && slider.value < 85) {
        var _iteratorNormalCompletion34 = true;
        var _didIteratorError34 = false;
        var _iteratorError34 = undefined;

        try {
            for (var _iterator34 = levels.children[Symbol.iterator](), _step34; !(_iteratorNormalCompletion34 = (_step34 = _iterator34.next()).done); _iteratorNormalCompletion34 = true) {
                var _item33 = _step34.value;

                var _attrID33 = _item33.getAttribute("id");

                if (_attrID33 === "level34") {
                    _item33.classList.remove("hidden");
                } else {
                    _item33.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 85 && slider.value < 87.5) {
        var _iteratorNormalCompletion35 = true;
        var _didIteratorError35 = false;
        var _iteratorError35 = undefined;

        try {
            for (var _iterator35 = levels.children[Symbol.iterator](), _step35; !(_iteratorNormalCompletion35 = (_step35 = _iterator35.next()).done); _iteratorNormalCompletion35 = true) {
                var _item34 = _step35.value;

                var _attrID34 = _item34.getAttribute("id");

                if (_attrID34 === "level35") {
                    _item34.classList.remove("hidden");
                } else {
                    _item34.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 87.5 && slider.value < 90) {
        var _iteratorNormalCompletion36 = true;
        var _didIteratorError36 = false;
        var _iteratorError36 = undefined;

        try {
            for (var _iterator36 = levels.children[Symbol.iterator](), _step36; !(_iteratorNormalCompletion36 = (_step36 = _iterator36.next()).done); _iteratorNormalCompletion36 = true) {
                var _item35 = _step36.value;

                var _attrID35 = _item35.getAttribute("id");

                if (_attrID35 === "level36") {
                    _item35.classList.remove("hidden");
                } else {
                    _item35.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 90 && slider.value < 92.5) {
        var _iteratorNormalCompletion37 = true;
        var _didIteratorError37 = false;
        var _iteratorError37 = undefined;

        try {
            for (var _iterator37 = levels.children[Symbol.iterator](), _step37; !(_iteratorNormalCompletion37 = (_step37 = _iterator37.next()).done); _iteratorNormalCompletion37 = true) {
                var _item36 = _step37.value;

                var _attrID36 = _item36.getAttribute("id");

                if (_attrID36 === "level37") {
                    _item36.classList.remove("hidden");
                } else {
                    _item36.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 92.5 && slider.value < 95) {
        var _iteratorNormalCompletion38 = true;
        var _didIteratorError38 = false;
        var _iteratorError38 = undefined;

        try {
            for (var _iterator38 = levels.children[Symbol.iterator](), _step38; !(_iteratorNormalCompletion38 = (_step38 = _iterator38.next()).done); _iteratorNormalCompletion38 = true) {
                var _item37 = _step38.value;

                var _attrID37 = _item37.getAttribute("id");

                if (_attrID37 === "level38") {
                    _item37.classList.remove("hidden");
                } else {
                    _item37.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 95 && slider.value < 97.5) {
        var _iteratorNormalCompletion39 = true;
        var _didIteratorError39 = false;
        var _iteratorError39 = undefined;

        try {
            for (var _iterator39 = levels.children[Symbol.iterator](), _step39; !(_iteratorNormalCompletion39 = (_step39 = _iterator39.next()).done); _iteratorNormalCompletion39 = true) {
                var _item38 = _step39.value;

                var _attrID38 = _item38.getAttribute("id");

                if (_attrID38 === "level39") {
                    _item38.classList.remove("hidden");
                } else {
                    _item38.classList.add("hidden");
                }
            }
        } catch (err) {
    ...
    } else if (slider.value >= 97.5 && slider.value < 100) {
        var _iteratorNormalCompletion40 = true;
        var _didIteratorError40 = false;
        var _iteratorError40 = undefined;

        try {
            for (var _iterator40 = levels.children[Symbol.iterator](), _step40; !(_iteratorNormalCompletion40 = (_step40 = _iterator40.next()).done); _iteratorNormalCompletion40 = true) {
                var _item39 = _step40.value;

                var _attrID39 = _item39.getAttribute("id");

                if (_attrID39 === "level40") {
                    _item39.classList.remove("hidden");
                } else {
                    _item39.classList.add("hidden");
                }
            }
        } catch (err) {
        ...
        try {
            for (var _iterator41 = levels.children[Symbol.iterator](), _step41; !(_iteratorNormalCompletion41 = (_step41 = _iterator41.next()).done); _iteratorNormalCompletion41 = true) {
                var _item40 = _step41.value;

                var _attrID40 = _item40.getAttribute("id");

                if (_attrID40 === "level41") {
                    _item40.classList.remove("hidden");
                } else {
                    _item40.classList.add("hidden");
                }
            }
        } catch (err) {
...
// Скрипт для отложенной подгрузки
