...
var _Offers = __webpack_require__(2135);

var _Offers2 = _interopRequireDefault(_Offers);

var _Outsourcing = __webpack_require__(2136);

var _Outsourcing2 = _interopRequireDefault(_Outsourcing);

var _RequestEstimate = __webpack_require__(2137);

var _RequestEstimate2 = _interopRequireDefault(_RequestEstimate);

var _slide = __webpack_require__(131);

var _slide2 = _interopRequireDefault(_slide);

var _Waves = __webpack_require__(2138);

var _Waves2 = _interopRequireDefault(_Waves);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// import OurExperience from "./what_we_do/qa/OurExperience";
function onLoad() {
    window.addEventListener("load", onLoad, false);

    _Offers2.default.init();
    //Outsourcing.init();
    ...
    if (canvasElement) {
        var animatedBackground = new _AnimatedBackground2.default(canvasElement);
    }
}

window.addEventListener("load", onLoad, false);

_RequestEstimate2.default.init();
_Waves2.default.init();
// OurExperience.init();
...
var svgSourceCodes = ['<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">\n' + '    <path fill="#000" fill-rule="nonzero" d="M7 4v16h10V4H7zm0-2h10a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zm0 14v2h10v-2H7zM7 5v2h10V5H7zm5 14a1 1 0 0 0-1 1h2a1 1 0 0 0-1-1z"/>\n' + '</svg>\n', '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">\n' + '    <path fill="#000" fill-rule="nonzero" d="M4 5v11h16V5H4zm10 13v2h2a1 1 0 0 1 0 2H8a1 1 0 0 1 0-2h2v-2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2h-6zm-2-3a1 1 0 0 0-1 1h2a1 1 0 0 0-1-1zm-8-3v2h16v-2H4z"/>\n' + '</svg>\n', '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">\n' + '    <path fill="#000" fill-rule="nonzero" d="M12.537 19.982A11.451 11.451 0 0 0 15.723 13H9.01a11.446 11.446 0 0 0 2.768 6.997 8.151 8.151 0 0 0 .758-.015zm3.236-.926A8.005 8.005 0 0 0 19.938 13H17.73a13.436 13.436 0 0 1-1.956 6.056zm.016-14.104A13.442 13.442 0 0 1 17.73 11h2.208a8.005 8.005 0 0 0-4.149-6.048zM15.724 11a11.452 11.452 0 0 0-3.086-6.893A11.461 11.461 0 0 0 9.098 11h6.626zm-6.777 8.397C7.749 17.507 7.09 15.369 7.009 13H4.062a8.008 8.008 0 0 0 4.885 6.397zm.814-15.08A8.008 8.008 0 0 0 4.06 11h3.022A13.44 13.44 0 0 1 9.76 4.318zM12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>\n' + '</svg>\n', '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">\n' + '    <path fill="#000" fill-rule="nonzero" d="M11 8v2h9V8h-9zm-2 8v-1a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H10a1 1 0 0 1-1-1v-1H4a1 1 0 0 1-1-1V4a1 1 0 1 1 2 0v4h4V7a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H10a1 1 0 0 1-1-1v-1H5v6h4zm2 0v2h9v-2h-9z"/>\n' + '</svg>\n', '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">\n' + '    <path fill="#000" fill-rule="nonzero" d="M6 4v16h12V8.952L13.273 4H6zM5 2h8.701a1 1 0 0 1 .724.31l5.298 5.551a1 1 0 0 1 .277.69V21a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zm4 14a1 1 0 0 0 0 2h6a1 1 0 0 0 0-2H9zm0-4a1 1 0 0 0 0 2h6a1 1 0 0 0 0-2H9z"/>\n' + '</svg>\n', '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">\n' + '    <path fill="#000" fill-rule="nonzero" d="M16.064 18.892a7.952 7.952 0 0 1-2.064.856V21a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-1.252a7.952 7.952 0 0 1-2.064-.856l-1.179 1.18a1 1 0 0 1-1.414 0L3.93 18.656a1 1 0 0 1 0-1.414l1.179-1.18A7.952 7.952 0 0 1 4.252 14H3a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1h1.252c.189-.734.48-1.427.856-2.064l-1.18-1.179a1 1 0 0 1 0-1.414L5.344 3.93a1 1 0 0 1 1.414 0l1.18 1.179A7.952 7.952 0 0 1 10 4.252V3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v1.252c.734.189 1.427.48 2.064.856l1.179-1.18a1 1 0 0 1 1.414 0l1.414 1.415a1 1 0 0 1 0 1.414l-1.179 1.18c.377.636.667 1.329.856 2.063H21a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-1.252a7.952 7.952 0 0 1-.856 2.064l1.18 1.179a1 1 0 0 1 0 1.414l-1.415 1.414a1 1 0 0 1-1.414 0l-1.18-1.179zM12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12z"/>\n' + '</svg>\n'];
...
function init() {
    ...
    switcherElement.buttons = document.querySelectorAll(".what-do-we-offer .card");
    switcherElement.slides = document.querySelectorAll(".what-do-we-offer .card-info");
    switcherElement.container = document.querySelector(".what-do-we-offer .card-info-container");

    swiperElement.container = document.querySelector(".what-do-we-offer .mobile-swiper-container");
    swiperElement.wrapper = swiperElement.container.querySelector(".card-info-container");
    swiperElement.slides = swiperElement.container.querySelectorAll(".card-info");
...
function destroySwiper() {
    if (swiper) {
        swiperElement.container.classList.remove("swiper-container");
        swiperElement.wrapper.classList.remove("swiper-wrapper");

        for (var i = 0; i < swiperElement.slides.length; i++) {
            swiperElement.slides[i].classList.remove("swiper-slide");
        }
...
function destroySwitcher() {
    for (var i = 0; i < switcherElement.buttons.length; i++) {
        var button = switcherElement.buttons[i];

        button.removeEventListener("click", onSwitcherButtonClick, false);
        button.classList.remove("active");
    }

    for (var _i = 0; _i < switcherElement.slides.length; _i++) {
        switcherElement.slides[_i].classList.remove("active");
    }
}
...
function initSwiper() {
    ...
    swiperElement.container.classList.add("swiper-container");
    swiperElement.wrapper.classList.add("swiper-wrapper");

    for (var i = 0; i < swiperElement.slides.length; i++) {
        swiperElement.slides[i].classList.add("swiper-slide");
    }

    swiper = new _swiper2.default(".what-do-we-offer .swiper-container", {
        initialSlide: currentOfferIndex,

        pagination: {
            el: ".what-do-we-offer .swiper-pagination",
            clickable: true,

            renderBullet: function renderBullet(index, className) {
                return '<div class="' + className + '">' + svgSourceCodes[index] + '</div>';
            }
        },

        on: {
            slideChange: function slideChange() {
                currentOfferIndex = this.activeIndex;
            }
        }
    });
}
...
function initSwitcher() {
    for (var i = 0; i < switcherElement.buttons.length; i++) {
        switcherElement.buttons[i].addEventListener("click", onSwitcherButtonClick, false);
    }

    selectSwitcherSlide(currentOfferIndex);
}

function update() {
    if (view.isPhone() && !isPhoneView) {
        isPhoneView = true;

        destroySwitcher();
        initSwiper();
    } else if (!view.isPhone() && isPhoneView) {
        isPhoneView = false;
    ...
    if (view.isPhone()) {
        switcherElement.container.style.height = "";
    } else if (view.isTablet() && view.isPortrait()) {
        updateContainerTabletPortraitHeight();
    } else {
        var height = 0;

        for (var i = 0; i < switcherElement.slides.length; i++) {
            var text = switcherElement.slides[i];
        ...
        switcherElement.container.style.height = height + "px";
    }
}

function updateContainerTabletPortraitHeight() {
    for (var i = 0; i < switcherElement.slides.length; i++) {
        var text = switcherElement.slides[i];

        if (text.classList.contains("active")) {
            switcherElement.container.style.height = text.offsetHeight + "px";
            break;
        }
    }
}

function selectSwitcherSlide(activeSlideIndex) {
    for (var i = 0; i < switcherElement.buttons.length; i++) {
        var button = switcherElement.buttons[i];
        button.classList.remove("active");
    ...
    for (var _i2 = 0; _i2 < switcherElement.slides.length; _i2++) {
        var slide = switcherElement.slides[_i2];

        slide.classList.remove("active");

        if (_i2 === activeSlideIndex) {
...
function onSwitcherButtonClick(e) {
    ...
    for (var i = 0; i < switcherElement.buttons.length; i++) {
        if (switcherElement.buttons[i] === closest && currentOfferIndex !== i) {
            currentOfferIndex = i;
            selectSwitcherSlide(currentOfferIndex);

            if (view.isTablet() && view.isPortrait()) {
                updateContainerTabletPortraitHeight();
            }
...
function init() {
    view = _View2.default.getInstance();
    swiperWrapper = document.querySelector(".outsourcing .swiper-wrapper");

    swiper = new _swiper2.default(".outsourcing .swiper-container", {
        init: false,

        navigation: {
            nextEl: ".outsourcing .swiper-button-next",
            prevEl: ".outsourcing .swiper-button-prev"
        },

        on: {
            transitionEnd: function transitionEnd() {
                swiperWrapper.style.transform = swiperWrapper.style.transform.replace(/(\d+)\.\d+/g, "$1");
            }
        }
    });
...
function updateSwiper() {
    swiper.params.slidesPerView = view.isPhone() ? 1 : 2;
    swiper.params.spaceBetween = view.isPhone() ? 20 : 40;
    swiper.update();
}
...
function init() {
    var container = document.querySelector("section.request_estimate .b-request_content");

    var h2 = document.createElement("h2");
    h2.innerHTML = "Get a Risk Free Initial QA Review";

    var h3 = document.createElement("h3");
    h3.innerHTML = "No Cost and No Obligation!";

    var h4 = container.querySelector("h4");

    var parent_h4 = h4.parentNode;

    // parent_h4.insertBefore(h3, h4);
    // parent_h4.insertBefore(h2, h3);
}
...
var _BottomWave = __webpack_require__(2139);

var _BottomWave2 = _interopRequireDefault(_BottomWave);

var _TopWave = __webpack_require__(2140);

var _TopWave2 = _interopRequireDefault(_TopWave);
...
function init() {
    var topWaveElements = document.querySelectorAll(".wave-top");
    var bottomWaveElements = document.querySelectorAll(".wave-bottom");

    for (var i = 0; i < topWaveElements.length; i++) {
        waves.push(new _TopWave2.default(topWaveElements[i]));
    }

    for (var _i = 0; _i < bottomWaveElements.length; _i++) {
        waves.push(new _BottomWave2.default(bottomWaveElements[_i]));
    }
...
var _Wave2 = __webpack_require__(824);
...
var BottomWave = function (_Wave) {
    _inherits(BottomWave, _Wave);

    function BottomWave(canvas) {
        _classCallCheck(this, BottomWave);

        var _this = _possibleConstructorReturn(this, (BottomWave.__proto__ || Object.getPrototypeOf(BottomWave)).call(this, canvas));

        _this._extraHeight = 10;
        return _this;
    }

    _createClass(BottomWave, [{
        key: "render",
        value: function render() {
            ...
            var waveHeight = canvasHeight - this._extraHeight;

            context.beginPath();
            context.moveTo(0, waveHeight);
            context.quadraticCurveTo(canvasWidth / 4, waveHeight - waveHeight * 1.4, canvasWidth / 2, waveHeight / 2);
            context.quadraticCurveTo(canvasWidth / 4 * 3, waveHeight * 1.4, canvasWidth, 0);
...
var TopWave = function (_Wave) {
    _inherits(TopWave, _Wave);

    function TopWave(canvas) {
        _classCallCheck(this, TopWave);

        var _this = _possibleConstructorReturn(this, (TopWave.__proto__ || Object.getPrototypeOf(TopWave)).call(this, canvas));

        _this._extraHeight = 10;
        return _this;
    }

    _createClass(TopWave, [{
        key: "render",
        value: function render() {
            var canvas = this.getCanvas();
            var context = this.getContext();
            ...
            context.quadraticCurveTo(canvasWidth / 4, waveHeight - waveHeight * 1.4 + this._extraHeight, canvasWidth / 2, waveHeight / 2 + this._extraHeight);
            context.quadraticCurveTo(canvasWidth / 4 * 3, waveHeight * 1.4 + this._extraHeight, canvasWidth, this._extraHeight);
...
var Wave = function () {
    ...
    _createClass(Wave, [{
        ...
        key: "render",
        value: function render() {
            throw new Error("Method render() is abstract.");
        }
    }, {
        key: "update",
