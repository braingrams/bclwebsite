...
var _Carousel = __webpack_require__(2110);
...
// require("./what_we_do/healthcare/structure-slider");
__webpack_require__(2113);
// require("./what_we_do/healthcare/structure-desktop-animation");
...
var tabNames = ['On-Demand & Virtual Services', 'Mobile Apps', 'Wearables & IoT', 'Big Data', 'Enhanced Security & Blockchain', 'AI & Machine Learning'];

var paginationElement = document.querySelector('.solutions__swiper-pagination');
var sliderSection = document.querySelector('.solutions');
var sliderOurProcess = sliderSection.querySelector('.solutions__swiper-container');
var sliderOurProcessMobile = sliderSection.querySelector('.solutions__swiper-container--content');
var sliderSectionContent = sliderSection.querySelector('.solutions__swiper-block');
var tabsContainer = sliderSection.querySelector('.solutions__tabs-container');
...
var getCurrentDevice = function getCurrentDevice() {
    if (view.isDesktopBase()) {
        currentDevice = 'desktop';
    } else if (view.isTablet() || view.isDesktopMini()) {
...
var changeContentSlideOurProcess = function changeContentSlideOurProcess(newIndex) {
    ...
    var activeContentSlideClassName = 'solutions__swiper-container--content__swiper-slide--active';
    var slides = document.querySelectorAll('.solutions__swiper-container--content__swiper-slide');
...
var initTabsAnimation = function initTabsAnimation(tabElements) {
    if (tabElements.length) {
        paginationElement.classList.add('solutions__swiper-pagination--loaded');
    }
};
...
var makeSimularSlidesHeight = function makeSimularSlidesHeight() {
    var slides = sliderOurProcessMobile.querySelectorAll('.solutions__swiper-container--content__content');
    var maxHeight = 0;

    for (var i = 0; i < slides.length; i++) {
        maxHeight = slides[i].clientHeight > maxHeight ? slides[i].clientHeight : maxHeight;
    }

    for (var _i = 0; _i < slides.length; _i++) {
        slides[_i].style.height = maxHeight + 'px';
    }
};
...
var sliderInit = function sliderInit() {
    if (currentDevice === 'desktop') {
        ourProcessSlider = new _swiper2.default(sliderOurProcess, {
            ...
            pagination: {
                ...
                renderBullet: function renderBullet(index, className) {
                    return '\n                        <div class=\'solutions__tab swiper-pagination-bullet\'>\n                            <div class=\'solutions__tab__line solutions__tab__line--default\'></div>\n                            <span>' + tabNames[index] + '</span>\n                            <div class=\'solutions__tab__line solutions__tab__line--progress\'></div>\n                        </div>\n                    ';
                }
            },
            ...
            on: {
                ...
                paginationRender: function paginationRender() {
                    progressTabs = tabsContainer.querySelectorAll('.solutions__tab__line--progress');
                }
            }
        });
        ...
        ourProcessSlider = new _swiper2.default(sliderOurProcessMobile, {
            ...
            pagination: {
                bulletActiveClass: 'solutions__bullets__item--active',
                bulletClass: 'solutions__bullets__item',
                clickable: true,
                el: '.solutions__bullets',
                type: 'bullets'
            },
            ...
            on: {
                ...
                paginationRender: function paginationRender() {
                    makeSimularSlidesHeight();
                    progressTabs = sliderSectionContent.querySelectorAll('.solutions__swiper-container--content__tab__line--progress');
                },
...
var initAutoPlay = function initAutoPlay() {
    var current = document.querySelector('.solutions');
    var bounding = current.getBoundingClientRect();
    tabElements = tabsContainer.querySelectorAll('.solutions__tab');
...
var clearedTabsLoading = function clearedTabsLoading() {
    if (paginationElement.classList.contains('solutions__swiper-pagination--loaded')) {
        paginationElement.classList.remove('solutions__swiper-pagination--loaded');
    }
};
...
var resizeHandlerSlider = function resizeHandlerSlider() {
    if (clientWidth !== document.body.clientWidth && currentDevice !== getCurrentDevice()) {
        ...
        tabElements = document.querySelectorAll('.solutions__tab');
...
var sliderMouseHandler = function sliderMouseHandler(evt) {
    ...
    var pauseClassName = 'solutions__tabs-container--paused';
...
anchorLink.addEventListener('click', function () {
    (0, _smoothScroll.scrollToSection)(currentSection, offset);
});

var resizeHandlerOffset = function resizeHandlerOffset() {
...
window.addEventListener('resize', resizeHandlerOffset);
...
var slider2 = document.querySelector('.structure2__slider');

var structureSlider2 = void 0;
var clientWidth2 = document.body.clientWidth2;

var touchEvents2 = document.querySelector('.touchevents');

var sliderInit = function sliderInit() {
    if (!view2.isDesktop() || touchEvents2) {
        structureSlider2 = new _swiper2.default(slider2, {
            mode: 'horizontal',
            speed: 250,
            slidesPerView: 'auto',
            loop: false,
            slideActiveClass: 'structure2__slide--active'
        });
    }
};

var resizeHandlerSlider = function resizeHandlerSlider() {
    if (clientWidth2 !== document.body.clientWidth) {
        clientWidth2 = document.body.clientWidth;
        touchEvents2 = document.querySelector('.touchevents');

        view2._resize();

        if (structureSlider2) {
            structureSlider2.destroy();
        }
...
var sliderInit = function sliderInit() {
    if (view.isMobile()) {
        swiperCarousel = new _swiper2.default(slider, {
            ...
            pagination: {
                bulletActiveClass: 'clients__bullets__item--active',
                bulletClass: 'clients__bullets__item',
                clickable: true,
                el: '.clients__bullets',
                type: 'bullets'
            },
...
function onScroll() {
    ...
    parallaxElements.forEach(function (parallaxElement) {
        ...
        parallaxElement.domElement.style.transform = "translate3d(0, " + elementTranslateY * parallaxElement.speed + "px, 0)";
    });
}
