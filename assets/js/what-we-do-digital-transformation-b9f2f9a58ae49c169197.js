...
module.exports = __webpack_require__(2071);
    ...
    if (containerElement1) {
        ...
        var handleResize = function handleResize() {
            if (window.matchMedia("(min-width: 1025px)").matches) {
                ...
                extraHeight = containerElement2.offsetWidth * 3;
        ...
        var handleScroll = function handleScroll() {
            ...
            var stopScrollOffsetY = getElementOffsetTop(scrollSectionElement) - 90;
            ...
            if (dy < 0) {
                ...
                if (lambda >= 0 && lambda <= 20) {
                    lHand = 100 - lambda * 5;
                    lHandScale = (20 - lambda) / 100 + 1;
                } else {
                    lHand = 0;
                    lHandScale = 1;
                }
                ...
                if (lambda >= 30 && lambda <= 60) {
                    opacityAfter = (lambda - 30) * 3.4;
                } else if (lambda < 30) {
                    opacityAfter = 0;
                } else {
                    opacityAfter = 100;
                ...
                // if (lambda >= 60 && lambda <= 70){
                //     cat1Left = -50 + ((lambda - 60) * 5);
                //     cat1Bottom = -50 + ((lambda - 60) * 5);
                // } else if(lambda < 60){
                //     cat1Left = -50;
                //     cat1Bottom = -50;
                // } else {
                ...
                // }
                //
                // if (lambda >= 70 && lambda <= 75){
                //     cat3Right = -50 + ((lambda - 70) * 10);
                // } else if(lambda < 70){
                //     cat3Right = -50;
                // } else {
                //     cat3Right = 0;
                // }
                //
                // if (lambda >= 75 && lambda <= 80){
                //     cat2Left = -50 + ((lambda - 75) * 10);
                //     cat2Top = -50 + ((lambda - 75) * 10);
                // } else if(lambda < 75){
                //     cat2Left = -50;
                //     cat2Top = -50;
                // } else {
                ...
                // }
                //
                // if (lambda >= 80 && lambda <= 90){
                //     cat4Right = -50 + ((lambda - 80) * 5);
                //     cat4Bottom = -50 + ((lambda - 80) * 5);
                // } else if(lambda < 80){
                //     cat4Right = -50;
                //     cat4Bottom = -50;
                // } else {
                ...
                // if (lambda >= 60 && lambda <= 75){
                //     cat1Left = -50 + ((lambda - 60) * 10 / 3);
                //     cat1Bottom = -50 + ((lambda - 60) * 10 / 3);
                //
                // } else if(lambda < 60){
                //     cat1Left = -50;
                //     cat1Bottom = -50;
                ...
                // }
                //
                // if (lambda >= 65 && lambda <= 80){
                //     cat3Right = -50 + ((lambda - 65) * 10 / 3);
                //
                // } else if(lambda < 70){
                //     cat3Right = -50;
                // } else {
                ...
                // }
                //
                // if (lambda >= 70 && lambda <= 85){
                //     cat2Left = -50 + ((lambda - 70) * 10 / 3);
                //     cat2Top = -50 + ((lambda - 70) * 10 / 3);
                //
                // } else if(lambda < 75){
                //     cat2Left = -50;
                //     cat2Top = -50;
                ...
                // }
                //
                // if (lambda >= 75 && lambda <= 90){
                //     cat4Right = -50 + ((lambda - 75) * 10 / 3);
                //     cat4Bottom = -50 + ((lambda - 75) * 10 / 3);
                //
                // } else if(lambda < 80){
                //     cat4Right = -50;
                //     cat4Bottom = -50;
                ...
                if (lambda >= 60 && lambda <= 75) {
                    cat1Left = -30 + (lambda - 60) * 2;
                    cat1Bottom = -30 + (lambda - 60) * 2;
                } else if (lambda < 60) {
                    cat1Left = -30;
                    cat1Bottom = -30;
                } else {
                ...
                if (lambda >= 70 && lambda <= 85) {
                    cat2Left = -30 + (lambda - 70) * 2;
                    cat2Top = -30 + (lambda - 70) * 2;
                } else if (lambda < 75) {
                    cat2Left = -30;
                    cat2Top = -30;
                } else {
                ...
                if (lambda >= 75 && lambda <= 90) {
                    cat4Right = -30 + (lambda - 75) * 2;
                    cat4Bottom = -30 + (lambda - 75) * 2;
                } else if (lambda < 80) {
                    cat4Right = -30;
                    cat4Bottom = -30;
                } else {
                ...
                if (lambda >= 90 && lambda <= 100) {
                    blanket = -52 + (lambda - 90) * 5;
                } else if (lambda < 90) {
                    blanket = -50;
                } else {
                    blanket = -2;
            ...
            handLeft.style.top = Math.round(lHand) + "%";
            handLeft.style.transform = "scale(" + lHandScale + ")";
            handRight.style.top = Math.round(rHand) + "%";

            // handLeft.style.transform=`translateY(${Math.round(lHand)}%) scale(${lHandScale})`;
            //
            // handRight.style.transform = `translateY(${Math.round(rHand)}%)`;

            imgAfter.style.opacity = Math.round(opacityAfter) + "%";

            imgCat1.style.left = Math.round(cat1Left) + "%";
            imgCat1.style.bottom = Math.round(cat1Bottom) + "%";

            // imgCat1.style.transform = `translate3d(${Math.round(cat1Left)}%,${Math.round(cat1Bottom)}%,0)`;

            imgCat2.style.left = Math.round(cat2Left) + "%";
            imgCat2.style.top = Math.round(cat2Top) + "%";

            // imgCat2.style.transform = `translate3d(${Math.round(cat2Left)}%,${Math.round(cat2Left)}%,0)`;

            imgCat3.style.right = Math.round(cat3Right) + "%";

            // imgCat3.style.transform = `translateX(${Math.round(cat3Right)}%)`;

            imgCat4.style.right = Math.round(cat4Right) + "%";
            imgCat4.style.bottom = Math.round(cat4Bottom) + "%";

            imgBlanket.style.bottom = Math.round(blanket) + "%";

            // imgCat4.style.transform = `translate3d(${Math.round(cat4Right)}%,${Math.round(cat4Right)}%,0)`;
        };

        var containerElement2 = containerElement1.querySelector(".landing__scrollable-container-2");
        var scrollSectionElement = containerElement1.querySelector(".dt__animation");

        var handLeft = containerElement1.querySelector(".dt__animation__hand-l");
        var handRight = containerElement1.querySelector(".dt__animation__hand-r");

        var imgAfter = containerElement1.querySelector(".dt__animation__img-after");

        var imgCat1 = containerElement1.querySelector(".dt__animation__cat-1");
        var imgCat2 = containerElement1.querySelector(".dt__animation__cat-2");
        var imgCat3 = containerElement1.querySelector(".dt__animation__cat-3");
        var imgCat4 = containerElement1.querySelector(".dt__animation__cat-4");

        var imgBlanket = containerElement1.querySelector(".dt__animation__blanket");
        ...
        var lHand = void 0;
        var lHandScale = void 0;

        var rHand = void 0;

        var opacityAfter = void 0;

        var cat1Left = void 0;
        var cat1Bottom = void 0;

        var cat2Left = void 0;
        var cat2Top = void 0;

        var cat3Right = void 0;

        var cat4Right = void 0;
        var cat4Bottom = void 0;
...
var view = _View2.default.getInstance();
var section = document.querySelector('.wwd__verticals');
