webpackJsonp(
  [43],
  {
        ...
        _createClass(View, [
          ...
          },
          {
            ...
            value: function _resize() {
              ...
              this._desktopMini = window.matchMedia(
                "(min-width: 1025px) and (max-width: 1279px)"
              ).matches;
              this._desktopSmall = window.matchMedia(
                "(min-width: 1025px) and (max-width: 1440px)"
              ).matches;
              this._desktopBase = window.matchMedia(
                "(min-width: 1280px)"
              ).matches;
              ...
              var orientationChanged = !(
                (this._landscape &&
                  this._html.classList.contains("landscape")) ||
                (!this._landscape && this._html.classList.contains("portrait"))
              );
              ...
              if (orientationChanged) {
                ...
                this._html.classList.add(
                  this._landscape ? "landscape" : "portrait"
                );
              }
            },
    ...
    /***/ 1656: /***/ function (module, exports, __webpack_require__) {
      ...
      function setDOM(clientsJson) {
        if (clientsJson) {
          ...
          var beforeElements = [
            document.querySelector(".js-tile.shots"),
            document.querySelector(".js-tile.kensington_presentair"),
            document.querySelector(".js-tile.firecore"),
            document.querySelector(".js-tile.firecore"),
            document.querySelector(".js-tile.twin_river_casino"),
            document.querySelector(".js-tile.stada"),
          ];
          ...
          for (var _i = 0; _i < tiles.length; _i++) {
            ...
            if (
              _tile.classList.contains("project") ||
              _tile.classList.contains("testimonial")
            ) {
      ...
      function enableBtnSlider() {
        sliders = DOM.sliders.map(function (item) {
          if (hasButtons(item)) {
            ...
            return (0, _importsLoaderGlobalWindowLory.lory)(item, {
      ...
      function changeBreakpoint(wrap, index) {
        var breakpoints = Array.apply(
          null,
          wrap.querySelectorAll(".js-development_breakpoint")
        );
      ...
      function enableDefaultHandlers() {
        ...
        if (!isEnableDefaultHandlers) {
          ...
          list = Array.apply(
            null,
            document.querySelectorAll(".js-development, .js-landing")
          );
          ...
          list.map(function (item) {
            item.addEventListener("mouseenter", function () {
              ...
              var icon = this.querySelector(
                ".b-development_icon .b-development_icon_wrap"
              );
      ...
      function reBuildTiles() {
        DOM.tiles.map(function (tile, i) {
          ...
          if (
            i === DOM.tiles.length - 1 &&
            tile.classList.contains("development")
          ) {
            var index = i - 1;

            while (
              DOM.tilesWrap.offsetWidth - (tile.offsetLeft + tile.offsetWidth) >
              0
            ) {
            ...
            offsetPrevTile =
              DOM.tilesWrap.offsetWidth -
              (prevTile.offsetWidth + prevTile.offsetLeft);
        ...
        DOM.tiles.forEach(function (item) {
          if (item.classList.contains("b-tile_testimonial")) {
            if (item.offsetWidth < 300) {
              item
                .getElementsByClassName("b-testimonial_photo")[0]
      ...
      function createProjectTileContent(data) {
        ...
        if (tileLogos[data.name]) {
          html +=
            ...
            '" alt="' +
            data.title +
            "\" onload=\"this.parentNode.dataset.height = this.height; this.parentNode.style.height = this.height + 'px'; this.style.maxHeight = '100%';\">";
        }

        if (data.isExternalUrl) {
          html +=
            '<div class="b-project_external_icon">' +
            externalLinkIcon +
            "</div>";
        }
        ...
        if (data.isNDA) {
          ...
          html +=
            '<p class="b-project_descr b-project_text"><span>' +
            data.descr +
            "</span></p>";
        }
        ...
        if (data.platforms) {
          ...
          for (var i = 0; i < data.platforms.length; i++) {
            html +=
              '<li class="b-project_platform ' + data.platforms[i].name + '">';
            html +=
              '<div class="b-project_platform_icon">' +
              platformIcons[data.platforms[i]] +
              "</div>";
            html += "</li>";
          }
    ...
    /***/ 1658: /***/ function (module, exports, __webpack_require__) {
      module.exports =
        __webpack_require__.p +
        "assets/files/logo_henkel-7ef4152f8ab3615f453f9c8b574a9c68.svg";
    ...
    /***/ 1659: /***/ function (module, exports, __webpack_require__) {
      module.exports =
        __webpack_require__.p +
        "assets/files/logo_kia-a0ae9b2d46aedead553b5d3a15d711b9.svg";
    ...
    /***/ 1660: /***/ function (module, exports, __webpack_require__) {
      module.exports =
        __webpack_require__.p +
        "assets/files/logo_mars-99520a2a44a341770d650d0c643bc4bf.svg";
    ...
    /***/ 1661: /***/ function (module, exports, __webpack_require__) {
      module.exports =
        __webpack_require__.p +
        "assets/files/logo_nestle-e3f6a4e5011973e29ced661b41c45d76.svg";
    ...
    /***/ 1662: /***/ function (module, exports, __webpack_require__) {
      module.exports =
        __webpack_require__.p +
        "assets/files/logo_sberbank-f7031ae0bff2f8fca6b1e294742afcd6.svg";
    ...
    /***/ 1663: /***/ function (module, exports, __webpack_require__) {
      module.exports =
        __webpack_require__.p +
        "assets/files/logo_sony-2a463ddeacb866c0f4f3ca4cc474de07.svg";
    ...
    /***/ 1664: /***/ function (module, exports, __webpack_require__) {
      ...
      var layoutConfig = {
        desktop: function desktop(items, gridWidth) {
          ...
          for (var i = 0; i < items.length; i++) {
            ...
            var boundingPrevEl =
              i !== 0
                ? items[i - 1].getElement().getBoundingClientRect()
                : null;

            if (!elWidth) {
              elWidth = el.classList.contains("double")
                ? boundingEl.width / 2
                : boundingEl.width;
            ...
            elemsStack = el.classList.contains("double")
              ? elemsStack + 2
              : elemsStack + 1;
            ...
            (_layout$slots = layout.slots).push.apply(_layout$slots, [
              elWidth * kWidth,
              elHeight * heightElemsStack,
            ]);
            ...
            if (
              i !== 0 &&
              Math.round(boundingEl.width) === Math.round(elWidth) &&
              items[i - 1].getElement().classList.contains("double") &&
              Math.round(boundingPrevEl.width) +
                Math.round(lastElems[0].left) -
                Math.ceil(gridWidth) >
                1 &&
              lastElems[1].left === 0
            ) {
              ...
              i === items.length - 1 &&
              Math.ceil(boundingEl.width) +
                Math.ceil(lastElems[1].left) -
                Math.ceil(gridWidth) >
                1
            ) {
              layout.slots[layout.slots.length - 4] = 0;
              layout.slots[layout.slots.length - 3] =
                lastElems[1].top + elHeight;
              layout.slots[layout.slots.length - 2] = lastElems[0].left;
              layout.slots[layout.slots.length - 1] = lastElems[0].top;
      ...
      var initTiles = function initTiles() {
        ...
        var layout =
          !("ontouchstart" in document.documentElement) && !view.isPhone()
          ...
          if (arr.length === 0) {
            ...
            for (var j = 0; j < arr.length; j++) {
              ...
              if (!card.classList.contains(cardName)) {
                ...
                (!card.classList.contains("double") && cardName === "mobile") ||
                (!card.classList.contains("double") &&
                  cardName === "desktop") ||
                (!card.classList.contains("double") && cardName === "web") ||
                (!card.classList.contains("double") &&
                  cardName === "cutting_edge") ||
                (!card.classList.contains("double") && cardName === "qa")
              ) {
                card.dataset.visible = 0;
              } else {
                card.dataset.visible = 1;
      ...
      var getFiltereOut = function getFiltereOut() {
        tiles
          .filter(function (item) {
            var value = parseInt(
              item.getElement().getAttribute("data-visible")
            );
          ...
          .sort(function (b, a) {
            ...
            if (
              bNode === last &&
              bNode.classList.contains("qa") &&
              aNode.classList.contains("sns")
            ) {
              return -1;
            }
    ...
    /***/ 1665: /***/ function (module, exports, __webpack_require__) {
      ...
      !(function (t, e) {
        ...
        function a(t, e) {
          var i = h && h.get(t);
          return (
            i || ((i = window.getComputedStyle(t, null)), h && h.set(t, i)),
            i.getPropertyValue("transform" === e ? s : e)
          );
        }
        var _ = /([A-Z])/g;
        function l(t) {
        ...
        (p.prototype.start = function (t, e, i) {
          if (!this._isDestroyed) {
            ...
            if (
              (h && s.cancel(),
              (this._callback = c(o.onFinish) ? o.onFinish : null),
              !s || h)
            ) {
              ...
              (d[0] = t), (d[1] = e);
              var u = this._options;
              (u.duration = o.duration || 300), (u.easing = o.easing || "ease");
              var p = this._element;
              ((s = p.animate(d, u)).onfinish = this._onFinish),
                (this._animation = s),
                f(p, e);
            }
          }
        ...
        function g(t, e) {
          for (
            var i, s, n = e[0].toUpperCase() + e.slice(1), r = 0;
            r < m.length;

          ) {
            if ((s = (i = m[r]) ? i + n : e) in t) return s;
            ++r;
          }
          return null;
        }
        ...
        function M(t, e) {
          (this._element = t),
            ...
            this.setCssProps(e),
            this._touchAction || this.setTouchAction(P),
            t.addEventListener("dragstart", M._preventDefault, !1),
            t.addEventListener(M._events.start, this._preStartCheck, R),
            !E ||
              C ||
              L ||
              t.addEventListener(M._mouseEvents.start, this._preStartCheck, R);
        }
        function T() {
          (this._nextStep = null),
            (this._queue = []),
        ...
        (M._pointerEvents = {
          ...
          (M._activateInstance = function (t) {
            M._activeInstances.indexOf(t) > -1 ||
              (M._activeInstances.push(t),
              M._emitter.on(D, t._onMove),
              M._emitter.on(A, t._onCancel),
              M._emitter.on(b, t._onEnd),
              1 === M._activeInstances.length && M._bindListeners());
          }),
          (M._deactivateInstance = function (t) {
            var e = M._activeInstances.indexOf(t);
            -1 !== e &&
              (M._activeInstances.splice(e, 1),
              M._emitter.off(D, t._onMove),
              M._emitter.off(A, t._onCancel),
              M._emitter.off(b, t._onEnd),
              M._activeInstances.length || M._unbindListeners());
          }),
          (M._bindListeners = function () {
            var t = M._events;
            window.addEventListener(t.move, M._onMove, R),
              window.addEventListener(t.end, M._onEnd, R),
              t.cancel && window.addEventListener(t.cancel, M._onCancel, R);
          }),
          (M._unbindListeners = function () {
            var t = M._events;
            window.removeEventListener(t.move, M._onMove, R),
              window.removeEventListener(t.end, M._onEnd, R),
              t.cancel && window.removeEventListener(t.cancel, M._onCancel, R);
          }),
          ...
          (M.prototype._reset = function () {
            this._isDestroyed ||
              ...
              this._element.removeEventListener(
                M._touchEvents.start,
                this._abortNonCancelable,
                R
              ),
              M._deactivateInstance(this));
          }),
          (M.prototype._createEvent = function (t, e) {
            ...
            return {
              ...
              deltaTime: t === S ? 0 : this.getDeltaTime(),
              isFirst: t === S,
              isFinal: t === b || t === A,
          ...
          (M.prototype._getTrackedTouch = function (t) {
            return null === this._pointerId
              ? null
              : M._getTouchById(t, this._pointerId);
          }),
          (M.prototype._preStartCheck = function (t) {
            this._isDestroyed ||
              ...
              (I && !1 === t.cancelable) ||
              t.button ||
              ((this._pointerId = M._getEventPointerId(t)),
          ...
          (M.prototype.setTouchAction = function (t) {
            (this._touchAction = t),
              x && ((this._cssProps[x] = ""), (this._element.style[x] = t)),
              E &&
                (this._element.removeEventListener(
                  M._touchEvents.start,
                  M._preventDefault,
          ...
          (M.prototype.setCssProps = function (t) {
            if (t) {
              ...
              for (e in t) {
                t[e] &&
                  ("touchAction" !== e
                    ? (i = g(n.style, e)) && ((s[i] = ""), (n.style[i] = t[e]))
          ...
          (M.prototype.destroy = function () {
            if (!this._isDestroyed) {
              ...
              t.removeEventListener(e.start, this._preStartCheck, R),
              t.removeEventListener(
                M._mouseEvents.start,
                this._preStartCheck,
                R
              ),
              t.removeEventListener("dragstart", M._preventDefault, !1),
              t.removeEventListener(
                M._touchEvents.start,
                M._preventDefault,
                !1
          ...
          (T.prototype.cancel = function (t) {
            ...
            e > -1 &&
              ...
              delete this._reads[t],
              delete this._writes[t]);
          }),
          (T.prototype._step = function () {
            var t,
              ...
              h = this._batchWrites,
              a = i.length;
            for (this._nextStep = null, e = 0; e < a; e++) {
              (t = i[e]) &&
                (r.push(t),
                (o[t] = s[t]),
                delete s[t],
            ...
            (r.length = 0),
              !this._nextStep && i.length && (this._nextStep = y(this._step));
          });
        var k = new T(),
          X = "layout",
          Y = "visibility",
        ...
        function $(t, e, i) {
          var s =
            (typeof i === "undefined" ? "undefined" : _typeof(i)) === Z
              ? i
              : -1;
          s < 0 && (s = t.length - s + 1),
            t.splice.apply(t, U.concat(s, 0, e)),
            (U.length = 0);
        }
        function J(t, e, i) {
          var s = t.length,
            n = Math.max(0, i ? s : s - 1);
        ...
        function nt(t, e) {
          ...
          return e > 0
            ? function (n) {
                void 0 !== i &&
                  ((i = window.clearTimeout(i)), k.cancel(s), n === et && t()),
                  n !== tt &&
                    n !== et &&
        ...
        function ot(t, e) {
          for (
            var i = window.document, s = (e ? t : t.parentElement) || i;
            s && s !== i && "static" === a(s, "position") && !rt(s);
              ...
              : ((s.left = window.pageXOffset || 0),
                ...
                t.self === window.self
                  ...
                  : ((i = t.getBoundingClientRect()),
                    (s.left += i.left),
                    (s.top += i.top),
                    (s.left += ht(t, "border-left-width")),
                    (s.top += ht(t, "border-top-width")),
                    s))
          );
        }
        function ct(t, e, i) {
          return (
            ...
            t === e
              ...
              : (dt(t, at),
                dt(e, _t),
                (lt.left = _t.left - at.left),
                (lt.top = _t.top - at.top),
                lt)
          );
        }
        var ut = "overflow",
        ...
        function Lt(t) {
          ...
          var i = bt.test(e),
            s = e.replace(i ? Et : At, ""),
            n = s.replace(Ct, "");
          return (wt.x = parseFloat(s) || 0), (wt.y = parseFloat(n) || 0), wt;
        }
        function It(t, e) {
        ...
        function Xt(t) {
          ...
          (this._item = t),
            ...
            (this._isDestroyed = !1),
            (this._isMigrating = !1),
            (this._startPredicate = c(s.dragStartPredicate)
              ? s.dragStartPredicate
              : Xt.defaultStartPredicate),
            (this._startPredicateState = kt),
          ...
          var n = s.dragSortHeuristics.sortInterval;
          (this._checkOverlapDebounce = nt(this._checkOverlap, n)),
            (this._dragger = new M(e, s.dragCssProps)),
        ...
        (Xt.defaultStartPredicate = function (t, e, i) {
          var s = t._drag,
            n = s._startPredicateData || s._setupStartPredicate(i);
          if (!e.isFinal)
            return (
              !(
                !n.handleElement &&
                ((n.handleElement = s._getStartPredicateHandle(e)),
                !n.handleElement)
              ) &&
              (n.delay &&
                ((n.event = e),
          ...
          (Xt.defaultSortPredicate =
            ...
            function (t, e) {
              ...
              (xt.width = t._width),
                (xt.height = t._height),
                (xt.left = i._elementClientX),
                (xt.top = i._elementClientY);
              ...
              for (
                o === s
                  ? ((xt.left = i._gridX + t._marginLeft),
                    (xt.top = i._gridY + t._marginTop))
                  : (o._updateBorders(1, 0, 1, 0),
                    (c = o._left + o._borderLeft),
                    (u = o._top + o._borderTop)),
                  d = 0;
                d < o._items.length;
                d++
              ) {
                (_ = o._items[d])._isActive &&
                  _ !== t &&
                  ((a = !0),
                  (Pt.width = _._width),
                  (Pt.height = _._height),
                  (Pt.left = _._left + _._marginLeft + c),
                  (Pt.top = _._top + _._marginTop + u),
                  (l = Yt(xt, Pt)) > f && ((h = d), (f = l)));
              }
              return (
                f < n && t.getGrid() !== o && ((h = a ? -1 : 0), (f = 1 / 0)),
                f >= n && ((Mt.grid = o), (Mt.index = h), (Mt.action = r), Mt)
              );
            })),
              ...
              ? this._isMigrating
                ...
                : (N(t._id),
                  ...
                  e.parentNode !== i._element &&
                    (i._element.appendChild(e),
                    (e.style[n] = It(this._gridX, this._gridY))),
                  Rt(e, i._settings.itemDraggingClass),
                  this._reset(),
                  this)
              : this;
          }),
          ...
          (Xt.prototype._bindScrollListeners = function () {
            var t,
              ...
              s = this._container,
              n = this._scrollers;
            if (((n.length = 0), vt(this._item._element, !1, n), s !== i))
              for (vt(i, !0, (t = [])), e = 0; e < t.length; e++) {
          ...
          (Xt.prototype._getStartPredicateHandle = function (t) {
            var e = this._startPredicateData,
              ...
              s = i;
            if (!e.handle) return s;
            for (s = t.target; s && !W(s, e.handle); ) {
          ...
          (Xt.prototype._resetHeuristics = function (t) {
            (this._hBlockedIndex = null),
              (this._hX1 = this._hX2 = t.clientX),
              (this._hY1 = this._hY2 = t.clientY);
          }),
          (Xt.prototype._checkHeuristics = function (t) {
            ...
            var s = t.clientX,
              ...
              r = s - this._hX2,
              o = n - this._hY2,
              h = i > 3 && e.minBounceBackAngle > 0;
            if (
              (h || (this._hBlockedIndex = null),
              Math.abs(r) > i || Math.abs(o) > i)
            ) {
              if (h) {
                var a = Math.atan2(r, o),
                  _ = Math.atan2(this._hX2 - this._hX1, this._hY2 - this._hY1),
                  l = Math.atan2(Math.sin(a - _), Math.cos(a - _));
                Math.abs(l) > e.minBounceBackAngle &&
                  (this._hBlockedIndex = null);
              }
              return (
                (this._hX1 = this._hX2),
          ...
          (Xt.prototype._resetStartPredicate = function () {
            ...
            t &&
              (t.delayTimer &&
                (t.delayTimer = window.clearTimeout(t.delayTimer)),
          ...
          (Xt.prototype._checkOverlap = function () {
            if (this._isActive) {
              var t,
                ...
                o,
                h = this._item,
                a = this._getGrid()._settings;
              (t = c(a.dragSortPredicate)
                ? a.dragSortPredicate(h, this._dragEvent)
                : Xt.defaultSortPredicate(h, a.dragSortPredicate)) &&
                "number" == typeof t.index &&
                ((o = (e = h.getGrid()) !== (s = t.grid || e)),
                (i = e._items.indexOf(h)),
                (n = J(s._items, t.index, o)),
                (r = "swap" === t.action ? "swap" : "move"),
                (o || n !== this._hBlockedIndex) &&
                  (o
                    ? ((this._hBlockedIndex = null),
                      ...
                      s._hasListeners("beforeReceive") &&
                        s._emit("beforeReceive", {
                          item: h,
                          fromGrid: e,
                          fromIndex: i,
                          toGrid: s,
                      ...
                      s.layout())
                    : i !== n &&
                      ((this._hBlockedIndex = i),
                      ("swap" === r ? Q : K)(e._items, i, n),
          ...
          (Xt.prototype._finishMigration = function () {
            ...
            (this._isMigrating = !1),
              this.destroy(),
              Rt(r, d.itemClass),
              Rt(r, d.itemVisibleClass),
              Rt(r, d.itemHiddenClass),
              j(r, _.itemClass),
              j(r, o ? _.itemVisibleClass : _.itemHiddenClass),
              l !== c &&
                (l.appendChild(r),
                (e = ct(c, l, !0)),
                ((t = Lt(r)).x -= e.left),
              ...
              (i._drag = _.dragEnabled ? new Xt(i) : null),
              l !== c && (r.style[n] = It(t.x, t.y)),
              i._child.removeAttribute("style"),
              f(i._child, o ? _.visibleStyles : _.hiddenStyles),
              s.start();
          }),
          (Xt.prototype._preStartCheck = function (t) {
            this._startPredicateState === kt && (this._startPredicateState = 1),
              1 === this._startPredicateState
          ...
          (Xt.prototype._preEndCheck = function (t) {
            ...
            this._startPredicate(this._item, t),
              (this._startPredicateState = kt),
              e && this._isActive && this._onEnd(t);
          }),
          (Xt.prototype._onStart = function (t) {
            ...
            if (e._isActive) {
              var i,
                ...
                m = l !== _;
              this._resetHeuristics(t),
                m && (i = ct(d, _)),
                e.isPositioning() &&
                  e._layout.stop(!0, { transform: It(u, f) }),
                a._isActive &&
                  ((u -= a._containerDiffX),
                  (f -= a._containerDiffY),
                  a.stop(!0, { transform: It(u, f) })),
                e.isReleasing() && h._reset(),
                (this._isActive = !0),
                (this._dragEvent = t),
                (this._container = l),
                ...
                o.dragPlaceholder.enabled && e._dragPlaceholder.create(),
                r._emit("dragInit", e, t),
                m &&
                  ((this._containerDiffX = i.left),
                  (this._containerDiffY = i.top),
                  s.parentNode === l
                    ? ((this._gridX = u - this._containerDiffX),
                      (this._gridY = f - this._containerDiffY))
                    : ((this._left = u + this._containerDiffX),
                      (this._top = f + this._containerDiffY),
                      l.appendChild(s),
                      (s.style[n] = It(this._left, this._top)))),
                j(s, o.itemDraggingClass),
                this._bindScrollListeners(),
                r._emit("dragStart", e, t);
            }
          }),
          (Xt.prototype._onMove = function (t) {
            ...
            if (e._isActive) {
              ...
              if ("y" !== r) {
                var o = t.clientX - this._dragEvent.clientX;
                (this._left += o),
                  (this._gridX += o),
                  (this._elementClientX += o);
              }
              if ("x" !== r) {
                var h = t.clientY - this._dragEvent.clientY;
                (this._top += h),
                  (this._gridY += h),
          ...
          (Xt.prototype._applyMove = function () {
            var t = this._item;
            t._isActive &&
              ((t._element.style[n] = It(this._left, this._top)),
              this._getGrid()._emit("dragMove", t, this._dragEvent));
          }),
          ...
          (Xt.prototype._prepareScroll = function () {
            ...
            if (t._isActive) {
              var e,
                ...
                _ = this._elementClientY - h.top;
              this._container !== o &&
                ((e = ct(this._containingBlock, o)),
          ...
          (Gt.prototype._onLayoutStart = function () {
            var t = this._item,
              ...
              n = e._layout.slots[2 * i + 1];
            if (this._didMigrate || t._left !== s || t._top !== n) {
              var r, o, h;
              if (
                ((s += t._marginLeft),
                (n += t._marginTop),
                !(e._settings.dragPlaceholder.duration > 0) || this._didMigrate)
              ) {
                F(t._id);
                var a = { transform: It(s, n) };
                return (
                  this._animate.isAnimating()
                    ? this._animate.stop(a)
                    : f(this._element, a),
                  void (
                    this._didMigrate &&
                    (e.getElement().appendChild(this._element),
                    (this._didMigrate = !1))
                  )
                );
              }
          ...
          (Gt.prototype.create = function () {
            if (this.isActive()) this._resetAfterLayout = !1;
              ...
              var t,
                ...
                s = i._settings,
                n = this._animate;
              (t = c(s.dragPlaceholder.createElement)
                ? s.dragPlaceholder.createElement(e)
                : window.document.createElement("div")),
                (this._element = t),
                (n._element = t),
                (this._className = s.itemPlaceholderClass || ""),
                this._className && j(t, this._className);
              var r = e._left + e._marginLeft,
                o = e._top + e._marginTop;
              f(t, {
                display: "block",
                position: "absolute",
                left: "0",
          ...
          (Gt.prototype.reset = function () {
            if (this.isActive()) {
              ...
              (this._resetAfterLayout = !1),
                ...
                n.stop(),
                (n._element = null),
                i.off("dragReleaseEnd", this._onReleaseEnd),
                i.off("layoutStart", this._onLayoutStart),
                i.off("beforeSend", this._onMigrate),
                this._className &&
                  (Rt(t, this._className), (this._className = "")),
                t.parentNode.removeChild(t),
                (this._element = null),
                c(s.dragPlaceholder.onRemove) &&
                  s.dragPlaceholder.onRemove(e, t);
            }
          }),
          (Gt.prototype.updateDimensions = function (t, e) {
            this.isActive() &&
              f(this._element, { width: t + "px", height: e + "px" });
          }),
          ...
          (Ht.prototype.flush = function (t, e) {
            ...
            var r = 1 === n,
              o = r ? s[0] : s.slice(0);
            if (((s.length = 0), r)) return o(t, e), this;
            for (i = 0; i < n && (o[i](t, e), !this._isDestroyed); i++) {}
            return this;
          }),
          ...
          (Ot.prototype.start = function (t, e) {
            if (!this._isDestroyed) {
              var i,
                ...
                m = !t && !this._skipNextAnimation && u > 0;
              return (
                l && this._queue.flush(!0, o),
                d && (a._isPositioningStarted = !0),
                c(e) && this._queue.add(e),
                m
                  ? ((this._isActive = !0),
                    (this._animateOptions.easing = p),
                  ...
                  : (this._updateOffsets(),
                    ...
                    (i = o._animate.isAnimating()),
                    this.stop(!1, this._targetStyles),
                    !i && f(h, this._targetStyles),
                    (this._skipNextAnimation = !1),
                    this._finish())
              );
            }
          ...
          (Ot.prototype.stop = function (t, e) {
            ...
            return (
              ...
              k.cancel(i + X),
              s._animate.stop(e),
              Rt(s._element, s.getGrid()._settings.itemPositioningClass),
              (this._isActive = !1),
              t && this._queue.flush(!0, s),
              this
            );
          }),
          ...
          (Ot.prototype._updateTargetStyles = function () {
            this._isDestroyed ||
              (this._targetStyles.transform = It(
          ...
          (Ot.prototype._finish = function () {
            if (!this._isDestroyed) {
              ...
              this._isActive &&
                ((this._isActive = !1),
                Rt(t._element, t.getGrid()._settings.itemPositioningClass)),
                i._isActive && i.stop(),
                e._isActive && e.stop(),
          ...
          (Ot.prototype._startAnimation = function () {
            ...
            this._isInterrupted || j(t._element, e.itemPositioningClass),
              (this._currentStyles.transform = It(
                this._currentLeft,
                this._currentTop
              )),
              t._animate.start(
        ...
        (Nt.prototype.start = function (t, e, i) {
          ...
          var s,
            ...
            D = i || window.document.body;
          if ("number" == typeof e) s = J(w, e, !0);
          else {
            if (!(r = t._getItem(e))) return this;
            s = w.indexOf(r);
          }
          return (
            (c.isPositioning() || this._isActive || c.isReleasing()) &&
              ((l = (_ = Lt(u)).x), (d = _.y)),
            c.isPositioning() && c._layout.stop(!0, { transform: It(l, d) }),
            this._isActive &&
              ((l -= this._containerDiffX),
              (d -= this._containerDiffY),
              this.stop(!0, { transform: It(l, d) })),
            c.isReleasing() &&
              ((l -= c._release._containerDiffX),
              (d -= c._release._containerDiffY),
              c._release.stop(!0, { transform: It(l, d) })),
            c._visibility._stopAnimation(),
            c._drag && c._drag.destroy(),
            c._visibility._queue.flush(!0, c),
            m._hasListeners("beforeSend") &&
              m._emit("beforeSend", {
                item: c,
                fromGrid: m,
                fromIndex: S,
            ...
            Rt(u, g.itemClass),
            Rt(u, g.itemVisibleClass),
            Rt(u, g.itemHiddenClass),
            j(u, y.itemClass),
            j(u, p ? y.itemVisibleClass : y.itemHiddenClass),
            m._items.splice(S, 1),
            $(w, c, s),
            (c._gridId = t._id),
            D !== (o = u.parentNode) &&
              ...
              (h = ct(D, o, !0)),
              _ || ((l = (_ = Lt(u)).x), (d = _.y)),
              (u.style[n] = It(l + h.left, d + h.top))),
            c._child.removeAttribute("style"),
            f(c._child, p ? y.visibleStyles : y.hiddenStyles),
            (u.style.display = p ? "block" : "hidden"),
            (a = ct(D, v, !0)),
            c._refreshDimensions(),
            c._refreshSortData(),
            (c._drag = y.dragEnabled ? new Xt(c) : null),
            (this._isActive = !0),
            (this._container = D),
            (this._containerDiffX = a.left),
            (this._containerDiffY = a.top),
            m._hasListeners("send") &&
              m._emit("send", {
                item: c,
                fromGrid: m,
                fromIndex: S,
              ...
              this._container !== r &&
                (e ||
                  (t
                    ...
                    : (Bt.transform = It(s._left, s._top)),
                  (e = Bt)),
                r.appendChild(n),
                f(n, e)),
              (this._isActive = !1),
        ...
        function zt(t) {
          ...
          (this._item = t),
            ...
            j(i, e ? s.itemVisibleClass : s.itemHiddenClass),
            f(t._child, e ? s.visibleStyles : s.hiddenStyles);
        }
        (Ft.prototype.start = function () {
          ...
          return (
            (this._isActive = !0),
            j(t._element, e._settings.itemReleasingClass),
              ...
              n.parentNode !== o &&
                (e ||
                  (t
                    ...
                    : (qt.transform = It(s._left, s._top)),
                  (e = qt)),
                o.appendChild(n),
                f(n, e)),
          ...
          (Ft.prototype._reset = function () {
            if (!this._isDestroyed) {
              ...
              (this._isActive = !1),
                ...
                (this._containerDiffX = 0),
                (this._containerDiffY = 0),
                Rt(t._element, t.getGrid()._settings.itemReleasingClass);
            }
          }),
          (zt.prototype.show = function (t, e) {
            ...
            return this._isShowing || this._isHidden
              ? this._isShowing && !t
                ...
                : (this._isShowing ||
                    (n.flush(!0, i),
                    Rt(s, o.itemHiddenClass),
                    j(s, o.itemVisibleClass),
          ...
          (zt.prototype.hide = function (t, e) {
            ...
            return !this._isHiding && this._isHidden
              ...
              : (this._isHiding ||
                  (n.flush(!0, i),
                  j(s, o.itemHiddenClass),
                  Rt(s, o.itemVisibleClass)),
                r && n.add(r),
          ...
          (zt.prototype.destroy = function () {
            ...
            return (
              this._stopAnimation({}),
              s.flush(!0, t).destroy(),
              Rt(e, n.itemVisibleClass),
              Rt(e, n.itemHiddenClass),
              (this._item = null),
          ...
          (zt.prototype._stopAnimation = function (t) {
            if (!this._isDestroyed) {
              var e = this._item;
              B(e._id), e._animateChild.stop(t);
            }
          }),
        ...
        var Vt = {};
        zt.prototype._finishHide = function () {
          if (this._isHidden) {
            var t = this._item;
            (this._isHiding = !1),
              (Vt.transform = It(0, 0)),
        ...
        function Kt(t, e, i) {
          ...
          (this._id = Jt()),
            ...
            j(e, s.itemClass),
            "boolean" != typeof i && (i = "none" !== a(e, "display")),
            (this._isActive = i),
            (e.style.left = "0"),
            (e.style.top = "0"),
            (e.style[n] = It(0, 0)),
            ...
            (this._visibility = new zt(this)),
            (this._layout = new Ot(this)),
            (this._migrate = new Nt(this)),
            (this._release = new Ft(this)),
            (this._dragPlaceholder = new Gt(this)),
        ...
        (Kt.prototype.getGrid = function () {
          ...
          (Kt.prototype._refreshDimensions = function () {
            if (!this._isDestroyed && !this._visibility._isHidden) {
              ...
              (this._width = i.width),
                ...
                (this._marginLeft = Math.max(0, ht(t, "margin-left"))),
                (this._marginRight = Math.max(0, ht(t, "margin-right"))),
                (this._marginTop = Math.max(0, ht(t, "margin-top"))),
                (this._marginBottom = Math.max(0, ht(t, "margin-bottom"))),
                e && e.updateDimensions(this._width, this._height);
            }
          }),
          ...
          (Qt.prototype.getLayout = function (t, e, i, s, n) {
            var r,
              ...
              c = this._slotSizes;
            if (
              ((o.slots = s || this._slots),
              (o.width = a ? 0 : d ? Math.round(e) : e),
              (o.height = a ? (d ? Math.round(i) : i) : 0),
              (o.setWidth = a),
              (o.setHeight = !a),
              (o.slots.length = 0),
              (c.length = 0),
            ...
            function (t, e, i, s, n) {
              ...
              for (
                u.length = 0,
                  Wt.left = null,
                  Wt.top = null,
                  Wt.width = t._width + t._marginLeft + t._marginRight,
                  Wt.height = t._height + t._marginTop + t._marginBottom,
                  s &&
                    ((Wt.width = Math.round(Wt.width)),
                    (Wt.height = Math.round(Wt.height))),
                  _ = 0;
                _ < c.length;
                _++
              ) {
                if (
                  (o = c[_]) &&
                  ((r = this._getRect(o)),
                  Wt.width <= r.width + 0.001 && Wt.height <= r.height + 0.001)
                ) {
                  (Wt.left = r.left), (Wt.top = r.top);
                  break;
                }
              }
              for (
                null === Wt.left &&
                  ...
                  i || (a = !0)),
                  !e &&
                    Wt.top + Wt.height > d.height &&
                    (Wt.left > 0 &&
                      u.push(this._addRect(0, d.height, Wt.left, 1 / 0)),
                    Wt.left + Wt.width < d.width &&
                      u.push(
                        this._addRect(
                          Wt.left + Wt.width,
                          d.height,
                          d.width - Wt.left - Wt.width,
                          1 / 0
                        )
                      ),
                    (d.height = Wt.top + Wt.height)),
                  e &&
                    Wt.left + Wt.width > d.width &&
                    (Wt.top > 0 &&
                      u.push(this._addRect(d.width, 0, 1 / 0, Wt.top)),
                    Wt.top + Wt.height < d.height &&
                      u.push(
                        this._addRect(
                          d.width,
                ...
                if ((o = c[_]))
                  for (
                    r = this._getRect(o), h = this._splitRect(r, Wt), l = 0;
                    l < h.length;
                    l++
                  ) {
                    (o = h[l]),
                      (r = this._getRect(o)).width > 0.49 &&
                        r.height > 0.49 &&
                        ((!e && r.top < d.height) || (e && r.left < d.width)) &&
                        u.push(o);
                  }
              }
              u.length &&
                this._purgeRects(u).sort(
                  e ? this._sortRectsLeftTop : this._sortRectsTopLeft
                ),
                e
                  ? (d.width = Math.max(d.width, Wt.left + Wt.width))
                  : (d.height = Math.max(d.height, Wt.top + Wt.height)),
                d.slots.push(Wt.left, Wt.top),
                n && this._slotSizes.push(Wt.width, Wt.height),
                (this._freeSlots = u),
                (this._newSlots = c);
            })),
              ...
              return (
                ...
                this._doRectsOverlap(t, e)
                  ? (t.left < e.left &&
                    ...
                    t.top < e.top &&
                      jt.push(
                        this._addRect(t.left, t.top, t.width, e.top - t.top)
                      ),
                    ...
                    jt)
                  : (jt.push(this._addRect(t.left, t.top, t.width, t.height)),
                    jt)
              );
            })),
          ...
          (Qt.prototype._purgeRects =
            ((Ut = {}),
            (Zt = {}),
            function (t) {
              for (var e, i = t.length; i--; ) {
                if (((e = t.length), t[i]))
                  for (this._getRect(t[i], Ut); e--; ) {
                    if (
                      t[e] &&
                      i !== e &&
                      this._isRectWithinRect(Ut, this._getRect(t[e], Zt))
                    ) {
                      t[i] = 0;
                      break;
                    }
        ...
        function oe(t) {
          return (
            (typeof t === "undefined" ? "undefined" : _typeof(t)) === se &&
            re.call(t) === ne
          );
        }
        function he(t) {
        ...
        function ce(e, s) {
          ...
          if (
            !((e = this._element =
              (typeof e === "undefined" ? "undefined" : _typeof(e)) === de
          ...
          c(
            (n = this._settings =
              (function (t, e) {
                ...
                return (
                  ...
                  (i.hiddenStyles =
                    (e || 0).hiddenStyles || (t || 0).hiddenStyles),
                  i
                );
              })(ce.defaultOptions, s)).dragSort
          ) || (n.dragSort = !!n.dragSort),
            (this._id = Jt()),
            (t[this._id] = h),
            (this._isDestroyed = !1),
            (this._layout = {
            ...
            (this._emitter = new i()),
            j(e, n.containerClass),
            (this._items = []),
            _typeof((r = n.items)) === de
              ? he(e.children).forEach(function (t) {
                  ("*" === r || W(t, r)) && h._items.push(new Kt(h, t));
                })
              : (Array.isArray(r) || ie(r)) &&
                (this._items = he(r).map(function (t) {
                  return new Kt(h, t);
                })),
            _typeof((o = n.layoutOnResize)) !== le && (o = !0 === o ? 0 : -1),
            o >= 0 &&
              window.addEventListener(
                "resize",
                (h._resizeHandler = nt(function () {
        ...
        return (
          (ce.Item = Kt),
          (ce.ItemLayout = Ot),
          (ce.ItemVisibility = zt),
          (ce.ItemMigrate = Nt),
          (ce.ItemAnimate = p),
          (ce.ItemDrag = Xt),
          (ce.ItemRelease = Ft),
          (ce.ItemDragPlaceholder = Gt),
          (ce.Emitter = i),
          (ce.Dragger = M),
          (ce.Packer = Qt),
          (ce.defaultOptions = {
          ...
          (ce.prototype.synchronize = function () {
            ...
            if (n.length) {
              for (i = 0; i < n.length; i++) {
                (e = n[i]._element).parentNode === s &&
                  (t =
                    t || window.document.createDocumentFragment()).appendChild(
                    e
                  );
              }
              t && s.appendChild(t);
            ...
            function f() {
              if (!(--u > 0)) {
                var s = o._layout.id !== l,
                  n = c(t) ? t : i;
                c(n) && n(s, _.items.slice(0)),
                  !s && o._hasListeners(e) && o._emit(e, _.items.slice(0));
              }
            }
            if (
              (((_.setHeight && _typeof(_.height) === le) ||
                (_.setWidth && _typeof(_.width) === le)) &&
                (s = "border-box" === a(h, "box-sizing")),
              _.setHeight &&
                (_typeof(_.height) === le
                  ? (h.style.height =
                      (s
                        ? _.height + this._borderTop + this._borderBottom
                        : _.height) + "px")
                  : (h.style.height = _.height)),
              _.setWidth &&
                (_typeof(_.width) === le
                  ? (h.style.width =
                      (s
                        ? _.width + this._borderLeft + this._borderRight
                        : _.width) + "px")
                  : (h.style.width = _.width)),
              this._hasListeners("layoutStart") &&
                this._emit("layoutStart", _.items.slice(0)),
              !d)
            )
              return f(), this;
            for (r = 0; r < d; r++) {
              (n = _.items[r]) &&
                ((n._left = _.slots[2 * r]),
                (n._top = _.slots[2 * r + 1]),
                n.isDragging() ? f() : n._layout.start(!0 === t, f));
            }
            return this;
          }),
          (ce.prototype.add = function (t, e) {
            ...
            for (n = 0; n < i.length; n++) {
              (s = new Kt(this, i[n], r.isActive)),
                (i[n] = s),
                s._isActive && ((a = !0), (s._layout._skipNextAnimation = !0));
            }
            return (
              $(h, i, r.index),
              this._hasListeners("add") && this._emit("add", i.slice(0)),
              a && o && this.layout("instant" === o, c(o) ? o : void 0),
              i
            );
          }),
          (ce.prototype.remove = function (t, e) {
            ...
            return (
              this._hasListeners("remove") &&
                this._emit("remove", a.slice(0), _),
              o && r && this.layout("instant" === r, c(r) ? r : void 0),
              a
            );
          }),
          ...
          (ce.prototype.filter = function (t, e) {
            ...
            if (
              ...
              for (s = 0; s < this._items.length; s++) {
                (i = this._items[s]),
                  (h ? t(i) : W(i._element, t)) ? n.push(i) : r.push(i);
              }
            return (
              n.length
                ? this.show(n, { instant: _, onFinish: f, layout: !1 })
                : f(),
              r.length
                ? this.hide(r, { instant: _, onFinish: f, layout: !1 })
                : f(),
              (n.length || r.length) &&
                (this._hasListeners("filter") &&
                  this._emit("filter", n.slice(0), r.slice(0)),
                l && this.layout("instant" === l, c(l) ? l : void 0)),
              this
            );
          }),
          (ce.prototype.sort = (function () {
            ...
            function o(o, h) {
              for (var a, _, l, d, c = 0, u = 0; u < t.length; u++) {
                if (
                  ((a = t[u][0]),
                  (_ = t[u][1]),
                  (l = (o._sortData ? o : o._refreshSortData())._sortData[a]),
            ...
            function h(o, h) {
              var a = t(o, h);
              return e && a && (a = -a), a || (s || (s = n(i)), r(o, h));
            }
            return function (n, r) {
              ...
              if (
                ...
                (typeof t === "undefined" ? "undefined" : _typeof(t)) === de
              )
                (t = n
                  .trim()
                  .split(" ")
              ...
              return (
                this._hasListeners("sort") && this._emit("sort", _.slice(0), i),
          ...
          (ce.prototype.send = function (t, e, i, s) {
            ...
            return (
              ...
              t._migrate._isActive &&
                t._isActive &&
                (o && this.layout("instant" === o, c(o) ? o : void 0),
          ...
          (ce.prototype.destroy = function (e) {
            ...
            return (
              Rt(s, this._settings.containerClass),
              (s.style.height = ""),
              (s.style.width = ""),
              this._emit("destroy"),
              this._emitter.destroy(),
          ...
          (ce.prototype._getItem = function (t) {
            ...
            if ((typeof t === "undefined" ? "undefined" : _typeof(t)) === le)
              return this._items[t > -1 ? t : this._items.length + t] || null;
            if (t instanceof Kt) return t._gridId === this._id ? t : null;
          ...
          (ce.prototype._updateLayout = function () {
            ...
            return (
              ...
              (i = c(r)
                ? r(n.items, t, e)
                : ae.getLayout(n.items, t, e, n.slots, r)),
              (n.slots = i.slots),
          ...
          (ce.prototype._updateBorders = function (t, e, i, s) {
            var n = this._element;
            t && (this._borderLeft = ht(n, "border-left-width")),
              e && (this._borderRight = ht(n, "border-right-width")),
              i && (this._borderTop = ht(n, "border-top-width")),
              s && (this._borderBottom = ht(n, "border-bottom-width"));
          }),
          ...
          (ce.prototype._setItemsVisibility = function (t, e, i) {
            ...
            if (d) {
              for (
                this._hasListeners(u) && this._emit(u, o.slice(0)), n = 0;
                n < o.length;
                n++
              ) {
                (s = o[n]),
                  ((e && !s._isActive) || (!e && s._isActive)) && (m = !0),
                  e && !s._isActive && (s._layout._skipNextAnimation = !0),
                  e && s._visibility._isHidden && y.push(s),
                  s._visibility[p](a, function (t, e) {
                    t || g.push(e),
                      --d < 1 &&
                        (c(_) && _(g.slice(0)),
                        r._hasListeners(f) && r._emit(f, g.slice(0)));
                  });
              }
              y.length && this.refreshItems(y),
                m && l && this.layout("instant" === l, c(l) ? l : void 0);
            } else c(_) && _(o);
          }),
          ce
        );
    ...
    /***/ 1667: /***/ function (module, exports, __webpack_require__) {
      ...
      var increasePopupCardTextHeight = function increasePopupCardTextHeight(
        el
      ) {
        var popupBlock = el.querySelectorAll(
          ".b-project_nda, .b-project_external"
        );
      ...
      var itemResize = function itemResize(target) {
        ...
        var incrementX = 0;
        if (elLeft === 0) incrementX = delta;
        else if (Math.ceil(elRight) >= document.body.clientWidth)
          incrementX = delta * -1;
        ...
        elStyles = elTransform && {
          ...
          transform:
            "translateX(" +
            (parseFloat(elTransform.x) + incrementX) +
            "px) translateY(" +
            elTransform.y +
            "px) " +
            (!isPopupOpen ? "scale(" + SCALE + ")" : ""),
        };
      ...
      var closePopupHandler = function closePopupHandler(evt) {
        ...
        if (
          !isPopupOpen ||
          (!evt.target.classList.contains("c-tiles--overlay") &&
            !evt.target.classList.contains("js-tile__btn"))
        ) {
          return;
        }
      ...
      var elMouseHandler = function elMouseHandler(evt) {
        ...
        target = target.classList.contains("js-tile-wrapper")
          ? target.querySelector(".js-tile")
          : target;
      ...
      var cardHoverInit = (exports.cardHoverInit = function cardHoverInit() {
        ...
        var itemsTiles = itemsContainer.querySelectorAll(
          ".js-tile-wrapper > .js-tile"
        );
    ...
    /***/ 1669: /***/ function (module, exports, __webpack_require__) {
      ...
      var calcPopupTextHeight = function calcPopupTextHeight(el, h) {
        var descriptions = el.querySelectorAll(
          ".b-project_nda-text, .b-project_external-block"
        );
      ...
      var makeMoveElems = function makeMoveElems(elem) {
        ...
        if (type === "mouseenter") {
          ...
          if (
            text.classList.contains("b-project_nda") ||
            text.classList.contains("b-project_external")
          ) {
      ...
      var elMouseHandler = function elMouseHandler(evt) {
        ...
        var cardType = target.classList.contains("b-project")
          ? "project"
          : "landing";
        var el = {
          img:
            cardType === "project"
              ? target.querySelector(".b-project_title-img")
              : target.querySelector(".b-landing_title"),
          text: target.querySelector(".b-project_descr-block"),
        };

        if (!el || Object.keys(el).length !== 2)
          throw new Error("There are no elements in card");
    ...
    /***/ 253: /***/ function (module, exports, __webpack_require__) {
      ...
      function setDOM() {
        DOM.elements = Array.apply(
          null,
          document.querySelectorAll(".js-animate_bg_pattern")
        );
      }
