  ...
  [19],
  {
    ...
    /***/ 116: /***/ function (module, exports, __webpack_require__) {
      ...
      module.exports = {
        ...
        request_estimate: _request_estimate2.default,
      };
    ...
    /***/ 118: /***/ function (module, exports) {
      module.exports = [
        { url: "/what-we-do", text: "What we do", title: "" },
        { url: "/portfolio", text: "Portfolio", title: "" },
        { url: "/company/about", text: "Company", title: "" },
        { url: "/careers/vacancies", text: "Careers", title: "" },
        { url: "/contacts", text: "Contacts", title: "" },
        { component: "request_estimate_link" },
    ...
    /***/ 119: /***/ function (module, exports) {
      module.exports = {
        miami: {
          type: { short: "Miami", full: "Miami Office" },
          address: "20533 Biscayne Blvd, Suite 732",
          place: { short: "Miami, FL", full: "Miami, FL 33180" },
          phone: { short: "305 767 2434", full: "+1 305-767-2434" },
        },
        atlanta: {
          type: { short: "Atlanta", full: "Atlanta Office" },
          place: { short: "Atlanta, GA", full: "" },
          phone: {
            short: "305 767 2434 (ext 102)",
            full: "+1 305 767 2434 (ext 102)",
            number: "+1 305 767 2434",
            ext: "102",
            fullExt: "(ext 102)",
          },
        },
        stuart: {
          type: { short: "Office in Stuart", full: "Office in Stuart" },
          address: "2682 SW Willoughby Blvd, Suite&nbsp;201",
          place: { short: "Stuart, FL", full: "Stuart, FL 34994" },
          phone: { short: "305 767 2434", full: "+1 305-767-2434" },
        },
        palmcity: {
          type: { short: "Palm City", full: "Palm City Office" },
          address: "901 SW Martin Downs Blvd, Suite&nbsp;321",
          place: { short: "Palm City, FL", full: "Palm City, FL 34990" },
          phone: { short: "305 767 2434", full: "+1 305-767-2434" },
        },
        cleveland: {
          type: { short: "Cleveland", full: "Cleveland Office" },
          place: { short: "Cleveland, OH", full: "" },
          phone: { short: "305 767 2434", full: "+1 305 767 2434" },
        },
        chicago: {
          type: { short: "Chicago", full: "Chicago Office" },
          place: { short: "Chicago, IL", full: "" },
          phone: { short: "305 767 2434", full: "+1 305 767 2434" },
        },
      };
    ...
    /***/ 120: /***/ function (module, exports) {
      module.exports = {
        ...
        adviser: ["Reference", "Clutch", "GoodFirms", "AppFutura", "Google"],
      };
    ...
    /***/ 131: /***/ function (module, exports, __webpack_require__) {
      ...
      slideRequestForm.prototype.setDOM = function (container) {
        ...
        this.DOM.requestAdviser = container.querySelector(
          ".js-request_success-adviser"
        );
      };
    ...
    /***/ 238: /***/ function (module, exports, __webpack_require__) {
      ...
      function AnimatedBackground(domElement, animation) {
        ...
        this._colors = AnimatedBackground._getColorsByBackgroundColorName(
          this._canvas.dataset.backgroundColorName
        );
      ...
      AnimatedBackground._RATIO =
        AnimatedBackground._WIDTH / AnimatedBackground._HEIGHT;

      AnimatedBackground._getColorsByBackgroundColorName = function (
        backgroundColorName
      ) {
      ...
      AnimatedBackground.prototype._animateCircles = function () {
        var offsetX = AnimatedBackground._getStaticShapeOffsetX(
          this._circles.length
        );
        ...
        for (var i = 0; i < this._circles.length; i++) {
          ...
          if (circle.rotation >= Math.PI * 4) {
            ...
            circle.y = AnimatedBackground._random(
              circleDiameter,
              AnimatedBackground._HEIGHT - circleDiameter
            );
            circle.x = AnimatedBackground._random(
              i * offsetX + circleDiameter,
              offsetX * (i + 1) - circleDiameter
            );
          }
        }
      };
      ...
      AnimatedBackground.prototype._animateCrosses = function () {
        ...
        for (var i = 0; i < this._crosses.length; i++) {
          ...
          if (cross.rotation >= Math.PI * 4) {
            ...
            cross.y = AnimatedBackground._random(
              doubleSize,
              AnimatedBackground._HEIGHT - doubleSize
            );
            cross.x = AnimatedBackground._random(
              i * offsetX + doubleSize,
              offsetX * (i + 1) - doubleSize
            );
          }
        }
      };
      ...
      AnimatedBackground.prototype._animateLines = function () {
        var offsetX = AnimatedBackground._getDynamicShapeOffsetX(
          this._lines.length
        );
        ...
        for (var i = 0; i < this._lines.length; i++) {
          ...
          if (
            line.x + halfLength < 0 ||
            line.y - halfLength > AnimatedBackground._HEIGHT
          ) {
            this._initLine(line);
            ...
            line.y = -halfLength;
            line.x =
              AnimatedBackground._random(centerX - boundX, centerX + boundX) -
              line.y;
          }
      ...
      AnimatedBackground.prototype._animateRectangles = function () {
        ...
        for (var i = 0; i < this._rectangles.length; i++) {
          ...
          if (
            rectangle.x + doubleSize < 0 ||
            rectangle.y - doubleSize > AnimatedBackground._HEIGHT
          ) {
      ...
      AnimatedBackground.prototype._createCircles = function (numberOfCircles) {
        var offsetX =
          AnimatedBackground._getStaticShapeOffsetX(numberOfCircles);
      ...
      AnimatedBackground.prototype._createCrosses = function (numberOfCrosses) {
        var offsetX =
          AnimatedBackground._getStaticShapeOffsetX(numberOfCrosses);
      ...
      AnimatedBackground.prototype._createLines = function (numberOfLines) {
        ...
        for (var i = 0; i < numberOfLines; i++) {
          ...
          line.y = AnimatedBackground._random(
            -halfLength,
            AnimatedBackground._HEIGHT + halfLength
          );
          line.x =
            AnimatedBackground._random(centerX - boundX, centerX + boundX) -
            line.y;
      ...
      AnimatedBackground.prototype._createRectangles = function (
        numberOfRectangles
      ) {
        var offsetX =
          AnimatedBackground._getDynamicShapeOffsetX(numberOfRectangles);
        ...
        for (var i = 0; i < numberOfRectangles; i++) {
          ...
          rectangle.y = AnimatedBackground._random(
            -doubleSize,
            AnimatedBackground._HEIGHT + doubleSize
          );
          rectangle.x =
      ...
      AnimatedBackground.prototype._getRandomColor = function () {
        var color =
          this._colors[Math.round(Math.random() * (this._colors.length - 1))];
        ...
        return (
          ...
          color[2] +
          ", " +
          AnimatedBackground._random(0.05, 0.16) +
          ")"
        );
      };
    ...
    /***/ 239: /***/ function (module, exports, __webpack_require__) {
      ...
      Circle.prototype.draw = function (context) {
        ...
        context.arc(
          0,
          0,
          (this.radius - this.thickness / 2) * this.scale,
          startAngle,
          endAngle
        );
        context.stroke();
    ...
    /***/ 252: /***/ function (module, exports, __webpack_require__) {
      ...
      var data = {
        ...
        aisle: {
          ...
          isExternalUrl: true,
          url_ios:
            "https://itunes.apple.com/us/app/shops-find-products-in-stores/id980392298?mt=8",
          url_android:
            "https://play.google.com/store/apps/details?id=com.aisle411.shops&hl=en",
          img: true,
          title: "Aisle411",
          descr:
            "BCL helped Aisle411 create a unique indoor navigation platform for retail stores that is now being developed as a partnership with Google Project Tango.",
          descr_seo_ios:
            "BCL mobile app developers helped Aisle411 create a unique indoor navigation platform for retail stores that is now being developed as a partnership with Google Project Tango. The project involved a series of custom iOS and Android applications, mobile app SDK development for integration into 3rd party apps and development of all necessary software tools for enterprise-scale map management.",
          descr_seo_ios_2:
            "Aisle411 platform has been deployed in more than 14,000 venues across retail, office, airports, conferences and more in the United States.",
        },
        barco: {
          name: "barco",
          type: "project",
        ...
        borran_software: {
          ...
          descr:
            "Borran Connect is a CRM solution for the real estate industry, which was purchased by the largest supplier of real estate office management software in North America.",
        },
        brandsource: {
          name: "brandsource",
          type: "project",
        ...
        bsecure: {
          ...
          title: "Bsecure",
          descr:
            "A cloud-based technology in the internet filtering industry and family online safety built for Bsecure, which was soon acquired by AVG Technologies.",
        },
        burger_king: {
          name: "burger_king",
          type: "project",
        ...
        comodo: {
          ...
          title: "Comodo",
          descr:
            "BCL Development built a new OS X application around Comodo AV library, creating a one-of-a-kind solution in malware detection.",
        },
        dow: {
          name: "dow",
          type: "project",
          ...
          descr_seo_ios:
            "Leveraging its experience in iOS app development and UX design, BCL has built a number of mobile applications for the sales and marketing division at Dow to assist them in their efforts. These apps now enable Dow marketing representatives to maximize sales opportunities at industry events.",
        },
        ecwid: {
          name: "ecwid",
          type: "project",
          ...
          descr_seo_ios:
            "BCL iOS experts helped Ecwid develop an iPhone application that lets more than 1 million sellers in 175 countries easily manage their online store, sell products on the go, and accept payments with PayPal Here.",
        },
        emojme: {
          name: "emojme",
          type: "project",
        ...
        eventicious: {
          ...
          url_ios:
            "https://itunes.apple.com/us/developer/BCL-devel/id767208467",
          url_android:
            "https://play.google.com/store/apps/developer?id=BCL+Development,+LLC",
          img: true,
          title: "Eventicious",
          descr:
            "The conference app builder is a complete event platform with web-based CMS and native mobile apps, allowing to automate business matchmaking system.",
        },
        eyeic: {
          name: "eyeic",
          type: "project",
        ...
        firecore: {
          ...
          title: "FireCore",
          descr:
            "A leader in creating home entertainment solutions partnered with BCL Development to incorporate new features into their player app for Apple TV.",
        },
        fitbit: {
          name: "fitbit",
          type: "project",
        ...
        ffps: {
          ...
          descr:
            "A mobile app, that allows team videographers create a soccer team introduction video using photos or short videos from the camera roll.",
        },
        google_glass: {
          name: "google_glass",
          type: "project",
        ...
        guardian: {
          ...
          title: "GuardianEdge",
          descr:
            "GuardianEdge provides data protection software for government and enterprises.",
        },
        henry_ford: {
          name: "henry_ford",
          type: "project",
        ...
        hex3: {
          ...
          isExternalUrl: true,
          url_android:
            "https://play.google.com/store/apps/details?id=co.hex3.apptagmultiplayer&hl=en",
          title: "AppTag",
          descr:
        ...
        jaja: {
          ...
          isExternalUrl: true,
          url_android:
            "https://play.google.com/store/apps/details?id=fareast.CloverPlugJaja&hl=en",
          title: "JaJa",
          img: true,
          descr:
        ...
        metova: {
          ...
          title: "Maritz Travel",
          descr:
            "Metova: Software Development Services For The BlackBerry[TM].",
        },
        ...
        mission_control: {
          ...
          descr:
            "A platform that lets companies create their own training and onboarding system for new employees.",
        },
        neuxpower: {
          name: "neuxpower",
          type: "project",
          title: "Neuxpower",
          descr:
            "Established in 1997, Neuxpower is a global leader in file optimization software.",
        },
        novartis_pharma: {
        ...
        pkware: {
          ...
          title: "Pkware",
          descr:
            "PKWARE, Inc. is a global technology leader known around the world as the expert in data compression and file management.",
        },
        ppm: {
          name: "ppm",
          type: "project",
        ...
        riproad: {
          ...
          title: "RipRoad",
          descr:
            "Rip Road is an SMS text messaging management solution, which has been successfully used by advertisers during US Open Tennis Championships for several years.",
        },
        sap: {
          name: "sap",
          type: "project",
          title: "SAP",
          descr:
            "SAP, the world's leading provider of business software, delivers products and services that help accelerate business innovation for its customers.",
        },
        second_street: {
          name: "second_street",
          type: "project",
        ...
        sns: {
          ...
          title: "SNS",
          descr:
            "SNS needed to optimize the software components of its flagship EVO to maximize existing hardware. BCL Development came up with the unique solution.",
        },
        spectrum: {
          name: "spectrum",
          type: "project",
        ...
        sound_streak: {
          ...
          descr:
            "SoundStreak Inc. develops 2-Picture™, the next generation voice-over production solution that makes professional sound recording easier.",
        },
        ...
        sterling: {
          ...
          title: "Stanley",
          descr:
            "Founded in 1949, Sterling Publishing is one of the world's leading publishers of non-fiction books.",
        },
        symantec: {
          name: "symantec",
          type: "project",
        ...
        toledo: {
          ...
          title: "Toledo",
          descr:
            "The University of Toledo is public metropolitan research university with 23,000 students and picturesque campuses recognized nationally for their beauty, located in Toledo, Ohio.",
        },
        // tom_sawyer_fest: {
        ...
        tonal: {
          ...
          title: "Tonal",
          descr:
            "Tonal is the world's most intelligent fitness system and BCL got involved in its development.",
          img: true,
        },
        thnks: {
          name: "thnks",
        ...
        verisurf: {
          ...
          title: "Verisurf",
          descr:
            "Verisurf Software, Inc. is a metrology software development company committed to delivering premier, field-proven computer-aided inspection and manufacturing solutions.",
        },
        wellez: {
          name: "wellez",
          type: "project",
          ...
          title: "WellEz",
          descr:
            "WellEz Mobile is a progress report visualization tool, developed for the oil well drilling industry.",
        },
        wobble: {
          name: "wobble",
          type: "project",
          ...
          url_ios:
            "https://itunes.apple.com/us/app/wobble-premium/id301166113?mt=8",
          title: "Wobble",
          descr:
          ...
          descr_seo_ios:
            "Wobble is a mobile app for iOS and Android that adds fun and interactive effect to still images. It lets users take a static picture, add targets, and shake, making the images jiggle. Wobble iOS app was Top 25 in the App Store for months and more than 1 million people now love to Wobble!",
        },
        ...
        yurbuds: {
          ...
          descr:
            "Yurtopia Yurbuds are soft rubber eartips meant to work with your existing phones, offering better fit and improved performance.",
        },
        google: {
          name: "google",
          type: "project",
      ...
      var scopes = [
        {
          ...
          title: "Custom",
          packs: [
            { id: "custom", title: "Custom", cards: [] },
            { id: "basic", title: "Basic (MVP)", cards: [] },
            { id: "proffesional", title: "Proffesional", cards: [] },
            { id: "business", title: "Business", cards: [] },
            { id: "enterprise", title: "Enterprise", cards: [] },
          ],
        },
        {
          id: "fitness",
      ...
      var groups = [
        {
          ...
          description:
            "Выберите платформу для которой необходимо разработать ваш проект",
          cards: [
            {
              id: "mobile-app",
              title: "Mobile App",
        ...
        },
        {
          ...
          title: "Контент",
          description:
            "Выберите функционал, который необходим вашему проекту. Для некоторого функционала предусмотрены разные цены в зависимости от способа реализации.",
          cards: [
            {
              id: "articles",
              title: "Articles",
            ...
            { id: "newsfeed", title: "Newsfeed", price: 2000 },
            {
              ...
              variants: [
                { title: "Native", price: 3000 },
                { title: "Custom", price: 5000 },
              ],
            },
            {
              id: "items",
    ...
    /***/ 341: /***/ function (module, exports, __webpack_require__) {
       ...
       */
      module.exports = [
        projects("google", { imgExt: "svg" }),
        projects("tonal", {}, function (project) {
          return {
            name: project.name,
            imgExt: "svg",
            url: project.url,
        ...
        projects("mercedes", { imgExt: "svg" }),
        projects("fitbit", { imgExt: "svg" }),
        projects("cisco", { imgExt: "svg" }),
        projects("burger_king", { imgExt: "svg" }),
        projects("philip_morris_i", { imgExt: "svg" }),
        projects("world_skills", { imgExt: "svg" }),
        projects("sap", {}, function (project) {
          return {
            name: project.name,
            main: project.main,
            imgExt: "svg",
        ...
        projects("hsbc", { imgExt: "svg" }),
        projects("dow", { imgExt: "svg" }),
        projects("leroy_merlin", { imgExt: "svg" }),
        projects("barco", { imgExt: "svg" }),
        projects("symantec", {}, function (project) {
          return {
            name: project.name,
            imgExt: "svg",
          };
        ...
        projects("grants", { imgExt: "svg" }),
        projects("grainger", {}, function (project) {
          return {
            name: project.name,
            imgExt: "svg",
          };
        ...
        projects("firecore", { imgExt: "svg" }),
        projects("university_of_virginia", {}, function (project) {
          return {
            name: project.name,
            imgExt: "svg",
          };
        ...
        projects("bladepad", { imgExt: "svg" }),
        projects("ecwid", {}, function (project) {
          return {
            name: project.name,
            imgExt: "svg",
          };
        ...
        projects("sns", { imgExt: "svg" }),
        projects("boiron", { imgExt: "svg" }),
        projects("novartis_pharma", { imgExt: "svg" }),
        projects("stada", { imgExt: "svg" }),
        projects("spectrum", {}, function (project) {
          return {
            name: project.name,
            imgExt: "svg",
          };
        ...
        projects("ppm", { imgExt: "svg" }),
        projects("f4", {}, function (project) {
          return {
            name: project.name,
            imgExt: "svg",
          };
        ...
        projects("eyeic", { imgExt: "svg" }),
        projects("shots", {}, function (project) {
          return {
            name: project.name,
            imgExt: "svg",
          };
    ...
    /***/ 343: /***/ function (module, exports) {
      module.exports = [
        ...
        { url: "/management", text: "Management" },
      ];
    ...
    /***/ 353: /***/ function (module, exports, __webpack_require__) {
      ...
      var data = {
        ...
        projects: [
          (0, _projects2.default)("fitbit", {}, function (project) {
            project.descr =
              "Fitbit is&nbsp;a&nbsp;market-leading ever-evolving consumer health technology and world-renowned brand aimed to&nbsp;empower and inspire people to&nbsp;live a&nbsp;healthier life through having fun.";
            return project;
          }),
          (0, _projects2.default)("burger_king", {}, function (project) {
            project.descr =
              "In&nbsp;search for a&nbsp;way to&nbsp;pump up&nbsp;the entire team of&nbsp;the fast food chain&rsquo;s employees, reduce the service time, and raise customer satisfaction.";
            return project;
          }),
          (0, _projects2.default)("tonal", {}, function (project) {
            project.descr =
              "Tonal&rsquo;s patented digital weight system makes thousands of&nbsp;calculations a&nbsp;second to&nbsp;deliver you a&nbsp;smooth weight lifting experience using magnets and electricity.";
            return project;
          }),
        ],
        clients: [
    ...
    /***/ 386: /***/ function (module, exports) {
      module.exports = {
        ios: { model: { name: "iPad Pro 12.9", image: "", dpr: "@2" } },
      };
    ...
    /***/ 392: /***/ function (module, exports, __webpack_require__) {
      ...
      var kensington_presentair = (0, _projects2.default)(
        "kensington_presentair"
      );
    ...
    /***/ 479: /***/ function (module, exports) {
      module.exports = [
        { hash: "#stat", year: "1991" },
        { hash: "#history", year: "1999" },
        { hash: "#spec", year: "2000" },
        { hash: "#cross", year: "2001" },
        { hash: "#focused", year: "2005" },
        { hash: "#ios", year: "2006" },
        { hash: "#jobs", year: "2007" },
        { hash: "#academy", year: "2008" },
        { hash: "#mimedia", year: "2009" },
        { hash: "#watch", year: "2015" },
      ];
    ...
    /***/ 480: /***/ function (module, exports) {
      module.exports = {
        mobile: { url: "/what-we-do/mobile", title: "Mobile Development" },
        desktop: { url: "/what-we-do/desktop", title: "Desktop Development" },
        web: { url: "/what-we-do/web", title: "Web Development" },
        "cutting-edge": {
          url: "/what-we-do/cutting-edge",
          title: "Cutting Edge",
        },
      };
    ...
    /***/ 481: /***/ function (module, exports) {
      module.exports = [
        {
          name: "running-ios-ad-hoc-builds",
          url: "/support/running-ios-ad-hoc-builds",
          text: "Running iOS Ad-Hoc Builds",
        },
        {
          name: "udid",
          url: "/support/udid",
          text: "How to Find Your iOS Device's UDID",
        },
        {
          name: "application-image-design-guidelines",
          url: "/support/application-image-design-guidelines",
          text: "Application Artwork Design Guidelines",
        },
      ];
    ...
    /***/ 484: /***/ function (module, exports, __webpack_require__) {
      ...
      function wheelMove(delta) {
        !isDisabled &&
          moveToSlide(delta > 0 ? getPrevSlideName() : getNextSlideName());
      }
      ...
      function onKeyDown(event) {
        ...
        if (isBodyTarget && !isDisabled && keycodes.isScroll(code)) {
          ...
          !isChange &&
            moveToSlide(
              keycodes.isUp(code) ? getPrevSlideName() : getNextSlideName()
            );
        }
      }
      ...
      function transformToSlide(name) {
        ...
        if (name && index > -1) {
          ...
          if (isDesktop) {
            ...
            DOM.wrap.style.transform =
              "translateY(-" + DOM.list[index].offsetTop + "px)";
          } else {
      ...
      function scrollToSlide(name) {
        ...
        if (name && index > -1) {
          ...
          if (isDesktop) {
            if (
              transitionSlides.isSupported() &&
              transitionSlides.isEnabled()
            ) {
      ...
      function isScrollSlide(slide) {
        return (
          slide.offsetTop + slide.offsetHeight / 2 > getElementScrollParamTop()
        );
      }
      ...
      module.exports = {
        ...
        scroll: function scroll(opt, callback) {
          ...
          reqAnimFrame(function animate(time) {
            ...
            if (isNewX) {
              x = isIncreaseX
                ? startX + progress * (opt.x - startX)
                : startX - progress * (startX - opt.x);
            }

            if (isNewY) {
              y = isIncreaseY
                ? startY + progress * (opt.y - startY)
                : startY - progress * (startY - opt.y);
            }
    ...
    /***/ 488: /***/ function (module, exports, __webpack_require__) {
      ...
      function normaliseDelta(e) {
        ...
        if ("detail" in e) {
          return Math.abs(e.detail) < 32765
            ? -e.detail * mouseWheelSpeed // Legacy Moz lines
    ...
    /***/ 491: /***/ function (module, exports, __webpack_require__) {
      ...
      function onAnimationEnd(currentSlideAnimationEnd, nextSlideAnimationEnd) {
        if (currentSlideAnimationEnd && nextSlideAnimationEnd) {
          ...
          nextSlide.className =
            nextSlide.dataset.slideClassName + " " + CURRENT_SLIDE_CLASS_NAME;
          ...
          if (showSlideProperties.index !== currentSlideIndex) {
            showSlide(
              showSlideProperties.index,
              showSlideProperties.onPostAnimationEnd
            );
          }
        }
      }
      ...
      function showSlide(slideIndex, slideEndChangeHandler) {
        ...
        function onCurrentSlideAnimationEnd() {
          currentSlide.removeEventListener(
            "animationend",
            onCurrentSlideAnimationEnd,
            false
          );
        ...
        nextSlide.className =
          nextSlide.className + " " + CURRENT_SLIDE_CLASS_NAME;

        currentSlide.className =
          currentSlide.className + " " + animationClass.out;
      ...
      function enable(slideIndex) {
        ...
        currentSlide.className =
          currentSlide.className + " " + CURRENT_SLIDE_CLASS_NAME;
    ...
    /***/ 492: /***/ function (module, exports, __webpack_require__) {
      ...
      function setDOM() {
        ...
        DOM.breakpoints = DOM.wrap
          ? Array.apply(null, DOM.wrap.querySelectorAll("li"))
          : [];
      }
      ...
      function toggleEvent(breakpoint) {
        isTouch
          ? breakpoint.removeEventListener("click", onBreakpointClick)
          : breakpoint.addEventListener("click", onBreakpointClick);
      }
      ...
      function removeBreakpointActive(breakpoint) {
        breakpoint.classList.contains("active") &&
    ...
    /***/ 493: /***/ function (module, exports, __webpack_require__) {
      ...
      function initHandlers() {
        DOM.element &&
          DOM.element.addEventListener("click", function () {
    ...
    /***/ 494: /***/ function (module, exports, __webpack_require__) {
       ...
       */
      function setDOM() {
        DOM.elements = Array.apply(
          null,
          document.querySelectorAll(".js-autotext")
        );
      }
    ...
    /***/ 495: /***/ function (module, exports, __webpack_require__) {
      ...
      Autotext.prototype.getStepTimeout = function () {
        return this.isStateDelete() && this.isFirstSymbol()
          ? 300
          : this.getDuration();
      };
      ...
      Autotext.prototype.isShowCursor = function () {
        return (
          this.isStateFinish() || (this.isStatePrint() && this.isFirstSymbol())
        );
      };
      ...
      Autotext.prototype.step = function () {
        ...
        this.isStart() &&
          this.isStateDelete() &&
          this.setStatePrint().setStateNextPhrase();
      ...
      Autotext.prototype.deleteText = function () {
        ...
        range.setStart(
          this.dom.childNodes[0],
          this.opt.prefix.length + this.state.counter + 1
        );
    ...
    /***/ 563: /***/ function (module, exports, __webpack_require__) {
      ...
      slideRequestForm.init(
        document.querySelector(".js-request_estimate-slide")
      );
